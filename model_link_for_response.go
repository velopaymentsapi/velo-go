...
// checks if the LinkForResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkForResponse{}
...
func (o LinkForResponse) MarshalJSON() ([]byte, error) {
...
func (o LinkForResponse) ToMap() (map[string]interface{}, error) {
...
type NullableLinkForResponse struct {
	value *LinkForResponse
	isSet bool
}

func (v NullableLinkForResponse) Get() *LinkForResponse {
	return v.value
}

func (v *NullableLinkForResponse) Set(val *LinkForResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkForResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkForResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkForResponse(val *LinkForResponse) *NullableLinkForResponse {
	return &NullableLinkForResponse{value: val, isSet: true}
}

func (v NullableLinkForResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkForResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
