...
func NewListSourceAccountResponsePage() *ListSourceAccountResponsePage {
	this := ListSourceAccountResponsePage{}
	return &this
}
...
func (o ListSourceAccountResponsePage) MarshalJSON() ([]byte, error) {
...
type NullableListSourceAccountResponsePage struct {
	value *ListSourceAccountResponsePage
	isSet bool
}

func (v NullableListSourceAccountResponsePage) Get() *ListSourceAccountResponsePage {
	return v.value
}

func (v *NullableListSourceAccountResponsePage) Set(val *ListSourceAccountResponsePage) {
	v.value = val
	v.isSet = true
}

func (v NullableListSourceAccountResponsePage) IsSet() bool {
	return v.isSet
}

func (v *NullableListSourceAccountResponsePage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSourceAccountResponsePage(val *ListSourceAccountResponsePage) *NullableListSourceAccountResponsePage {
	return &NullableListSourceAccountResponsePage{value: val, isSet: true}
}

func (v NullableListSourceAccountResponsePage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSourceAccountResponsePage) UnmarshalJSON(src []byte) error {
	v.isSet = true
