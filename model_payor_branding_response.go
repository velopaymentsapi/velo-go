...
type PayorBrandingResponse struct {
	...
	CollectiveAlias NullableString `json:"collectiveAlias,omitempty"`
	// The payor’s support contact address
	SupportContact NullableString `json:"supportContact,omitempty"`
	// The payor’s 'Doing Business As' name
	DbaName NullableString `json:"dbaName,omitempty"`
}
...
// GetCollectiveAlias returns the CollectiveAlias field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PayorBrandingResponse) GetCollectiveAlias() string {
	if o == nil || IsNil(o.CollectiveAlias.Get()) {
		var ret string
		return ret
	}
	return *o.CollectiveAlias.Get()
}
...
// SetCollectiveAlias gets a reference to the given NullableString and assigns it to the CollectiveAlias field.
func (o *PayorBrandingResponse) SetCollectiveAlias(v string) {
	o.CollectiveAlias.Set(&v)
}
// SetCollectiveAliasNil sets the value for CollectiveAlias to be an explicit nil
func (o *PayorBrandingResponse) SetCollectiveAliasNil() {
	o.CollectiveAlias.Set(nil)
}
...
func (o *PayorBrandingResponse) SetSupportContactNil() {
...
func (o *PayorBrandingResponse) SetDbaNameNil() {
	o.DbaName.Set(nil)
}
...
func (o PayorBrandingResponse) ToMap() (map[string]interface{}, error) {
	...
	if o.CollectiveAlias.IsSet() {
		toSerialize["collectiveAlias"] = o.CollectiveAlias.Get()
	}
	if o.SupportContact.IsSet() {
		toSerialize["supportContact"] = o.SupportContact.Get()
	}
	if o.DbaName.IsSet() {
		toSerialize["dbaName"] = o.DbaName.Get()
	}
