...
// checks if the PayorBrandingResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayorBrandingResponse{}
...
func (o PayorBrandingResponse) MarshalJSON() ([]byte, error) {
...
func (o PayorBrandingResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePayorBrandingResponse struct {
	value *PayorBrandingResponse
	isSet bool
}

func (v NullablePayorBrandingResponse) Get() *PayorBrandingResponse {
	return v.value
}

func (v *NullablePayorBrandingResponse) Set(val *PayorBrandingResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePayorBrandingResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePayorBrandingResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayorBrandingResponse(val *PayorBrandingResponse) *NullablePayorBrandingResponse {
	return &NullablePayorBrandingResponse{value: val, isSet: true}
}

func (v NullablePayorBrandingResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayorBrandingResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
