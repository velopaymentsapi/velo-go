...
// checks if the PayeeEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayeeEvent{}

// PayeeEvent Base type for all Payee Events
type PayeeEvent struct {
...
func (o PayeeEvent) MarshalJSON() ([]byte, error) {
...
func (o PayeeEvent) ToMap() (map[string]interface{}, error) {
...
type NullablePayeeEvent struct {
	value *PayeeEvent
	isSet bool
}

func (v NullablePayeeEvent) Get() *PayeeEvent {
	return v.value
}

func (v *NullablePayeeEvent) Set(val *PayeeEvent) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeEvent) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeEvent(val *PayeeEvent) *NullablePayeeEvent {
	return &NullablePayeeEvent{value: val, isSet: true}
}

func (v NullablePayeeEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
