...
// checks if the QueryBatchResponseV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryBatchResponseV3{}

// QueryBatchResponseV3 struct for QueryBatchResponseV3
...
// SetFailures gets a reference to the given []FailedSubmissionV3 and assigns it to the Failures field.
func (o *QueryBatchResponseV3) SetFailures(v []FailedSubmissionV3) {
	o.Failures = v
}

func (o QueryBatchResponseV3) MarshalJSON() ([]byte, error) {
...
func (o QueryBatchResponseV3) ToMap() (map[string]interface{}, error) {
...
type NullableQueryBatchResponseV3 struct {
	value *QueryBatchResponseV3
	isSet bool
}

func (v NullableQueryBatchResponseV3) Get() *QueryBatchResponseV3 {
	return v.value
}

func (v *NullableQueryBatchResponseV3) Set(val *QueryBatchResponseV3) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryBatchResponseV3) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryBatchResponseV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryBatchResponseV3(val *QueryBatchResponseV3) *NullableQueryBatchResponseV3 {
	return &NullableQueryBatchResponseV3{value: val, isSet: true}
}

func (v NullableQueryBatchResponseV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryBatchResponseV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
