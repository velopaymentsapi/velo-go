...
func (o PayeeInvitationStatus) MarshalJSON() ([]byte, error) {
...
type NullablePayeeInvitationStatus struct {
	value *PayeeInvitationStatus
	isSet bool
}

func (v NullablePayeeInvitationStatus) Get() *PayeeInvitationStatus {
	return v.value
}

func (v *NullablePayeeInvitationStatus) Set(val *PayeeInvitationStatus) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeInvitationStatus) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeInvitationStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeInvitationStatus(val *PayeeInvitationStatus) *NullablePayeeInvitationStatus {
	return &NullablePayeeInvitationStatus{value: val, isSet: true}
}

func (v NullablePayeeInvitationStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeInvitationStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
