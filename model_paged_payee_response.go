...
// SetContent gets a reference to the given []GetPayeeListResponse and assigns it to the Content field.
func (o *PagedPayeeResponse) SetContent(v []GetPayeeListResponse) {
	o.Content = v
}

func (o PagedPayeeResponse) MarshalJSON() ([]byte, error) {
...
type NullablePagedPayeeResponse struct {
	value *PagedPayeeResponse
	isSet bool
}

func (v NullablePagedPayeeResponse) Get() *PagedPayeeResponse {
	return v.value
}

func (v *NullablePagedPayeeResponse) Set(val *PagedPayeeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePagedPayeeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePagedPayeeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagedPayeeResponse(val *PagedPayeeResponse) *NullablePagedPayeeResponse {
	return &NullablePagedPayeeResponse{value: val, isSet: true}
}

func (v NullablePagedPayeeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagedPayeeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
