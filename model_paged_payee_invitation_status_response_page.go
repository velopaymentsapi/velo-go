...
func NewPagedPayeeInvitationStatusResponsePage() *PagedPayeeInvitationStatusResponsePage {
	this := PagedPayeeInvitationStatusResponsePage{}
	return &this
}
...
func (o PagedPayeeInvitationStatusResponsePage) MarshalJSON() ([]byte, error) {
...
type NullablePagedPayeeInvitationStatusResponsePage struct {
	value *PagedPayeeInvitationStatusResponsePage
	isSet bool
}

func (v NullablePagedPayeeInvitationStatusResponsePage) Get() *PagedPayeeInvitationStatusResponsePage {
	return v.value
}

func (v *NullablePagedPayeeInvitationStatusResponsePage) Set(val *PagedPayeeInvitationStatusResponsePage) {
	v.value = val
	v.isSet = true
}

func (v NullablePagedPayeeInvitationStatusResponsePage) IsSet() bool {
	return v.isSet
}

func (v *NullablePagedPayeeInvitationStatusResponsePage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagedPayeeInvitationStatusResponsePage(val *PagedPayeeInvitationStatusResponsePage) *NullablePagedPayeeInvitationStatusResponsePage {
	return &NullablePagedPayeeInvitationStatusResponsePage{value: val, isSet: true}
}

func (v NullablePagedPayeeInvitationStatusResponsePage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagedPayeeInvitationStatusResponsePage) UnmarshalJSON(src []byte) error {
	v.isSet = true
