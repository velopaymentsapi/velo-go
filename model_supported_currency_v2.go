...
// checks if the SupportedCurrencyV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportedCurrencyV2{}
...
func (o *SupportedCurrencyV2) GetMaxPaymentAmount() int32 {
	if o == nil || IsNil(o.MaxPaymentAmount) {
		var ret int32
		return ret
	}
...
func (o SupportedCurrencyV2) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Currency) {
		toSerialize["currency"] = o.Currency
	}
	if !IsNil(o.MaxPaymentAmount) {
