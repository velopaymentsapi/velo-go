...
// checks if the DebitEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DebitEvent{}

// DebitEvent Base type for all Debit Events
...
func (o DebitEvent) MarshalJSON() ([]byte, error) {
...
func (o DebitEvent) ToMap() (map[string]interface{}, error) {
...
type NullableDebitEvent struct {
	value *DebitEvent
	isSet bool
}

func (v NullableDebitEvent) Get() *DebitEvent {
	return v.value
}

func (v *NullableDebitEvent) Set(val *DebitEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableDebitEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableDebitEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDebitEvent(val *DebitEvent) *NullableDebitEvent {
	return &NullableDebitEvent{value: val, isSet: true}
}

func (v NullableDebitEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDebitEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
