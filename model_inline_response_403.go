...
// checks if the InlineResponse403 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineResponse403{}
...
func (o *InlineResponse403) SetCorrelationIdNil() {
...
func (o InlineResponse403) ToMap() (map[string]interface{}, error) {
