...
func (o *PayeeDeltaResponse) GetLinks() []PayeeDeltaResponseLinks {
	if o == nil || o.Links == nil {
		var ret []PayeeDeltaResponseLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []PayeeDeltaResponseLinks and assigns it to the Links field.
...
// SetContent gets a reference to the given []PayeeDelta and assigns it to the Content field.
func (o *PayeeDeltaResponse) SetContent(v []PayeeDelta) {
	o.Content = &v
}

func (o PayeeDeltaResponse) MarshalJSON() ([]byte, error) {
...
type NullablePayeeDeltaResponse struct {
	value *PayeeDeltaResponse
	isSet bool
}

func (v NullablePayeeDeltaResponse) Get() *PayeeDeltaResponse {
	return v.value
}

func (v *NullablePayeeDeltaResponse) Set(val *PayeeDeltaResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeDeltaResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeDeltaResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeDeltaResponse(val *PayeeDeltaResponse) *NullablePayeeDeltaResponse {
	return &NullablePayeeDeltaResponse{value: val, isSet: true}
}

func (v NullablePayeeDeltaResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeDeltaResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
