...
func (o *Company2) SetOperatingNameNil() {
...
func (o Company2) MarshalJSON() ([]byte, error) {
...
type NullableCompany2 struct {
	value *Company2
	isSet bool
}

func (v NullableCompany2) Get() *Company2 {
	return v.value
}

func (v *NullableCompany2) Set(val *Company2) {
	v.value = val
	v.isSet = true
}

func (v NullableCompany2) IsSet() bool {
	return v.isSet
}

func (v *NullableCompany2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompany2(val *Company2) *NullableCompany2 {
	return &NullableCompany2{value: val, isSet: true}
}

func (v NullableCompany2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompany2) UnmarshalJSON(src []byte) error {
	v.isSet = true
