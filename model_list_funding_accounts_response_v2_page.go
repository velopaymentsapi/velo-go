...
// checks if the ListFundingAccountsResponseV2Page type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListFundingAccountsResponseV2Page{}

// ListFundingAccountsResponseV2Page struct for ListFundingAccountsResponseV2Page
...
func NewListFundingAccountsResponseV2Page() *ListFundingAccountsResponseV2Page {
	this := ListFundingAccountsResponseV2Page{}
	return &this
}
...
func (o ListFundingAccountsResponseV2Page) MarshalJSON() ([]byte, error) {
...
func (o ListFundingAccountsResponseV2Page) ToMap() (map[string]interface{}, error) {
...
type NullableListFundingAccountsResponseV2Page struct {
	value *ListFundingAccountsResponseV2Page
	isSet bool
}

func (v NullableListFundingAccountsResponseV2Page) Get() *ListFundingAccountsResponseV2Page {
	return v.value
}

func (v *NullableListFundingAccountsResponseV2Page) Set(val *ListFundingAccountsResponseV2Page) {
	v.value = val
	v.isSet = true
}

func (v NullableListFundingAccountsResponseV2Page) IsSet() bool {
	return v.isSet
}

func (v *NullableListFundingAccountsResponseV2Page) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListFundingAccountsResponseV2Page(val *ListFundingAccountsResponseV2Page) *NullableListFundingAccountsResponseV2Page {
	return &NullableListFundingAccountsResponseV2Page{value: val, isSet: true}
}

func (v NullableListFundingAccountsResponseV2Page) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListFundingAccountsResponseV2Page) UnmarshalJSON(src []byte) error {
	v.isSet = true
