...
// checks if the SchedulePayoutRequestV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SchedulePayoutRequestV3{}

// SchedulePayoutRequestV3 struct for SchedulePayoutRequestV3
...
func (o SchedulePayoutRequestV3) MarshalJSON() ([]byte, error) {
...
func (o SchedulePayoutRequestV3) ToMap() (map[string]interface{}, error) {
...
type NullableSchedulePayoutRequestV3 struct {
	value *SchedulePayoutRequestV3
	isSet bool
}

func (v NullableSchedulePayoutRequestV3) Get() *SchedulePayoutRequestV3 {
	return v.value
}

func (v *NullableSchedulePayoutRequestV3) Set(val *SchedulePayoutRequestV3) {
	v.value = val
	v.isSet = true
}

func (v NullableSchedulePayoutRequestV3) IsSet() bool {
	return v.isSet
}

func (v *NullableSchedulePayoutRequestV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSchedulePayoutRequestV3(val *SchedulePayoutRequestV3) *NullableSchedulePayoutRequestV3 {
	return &NullableSchedulePayoutRequestV3{value: val, isSet: true}
}

func (v NullableSchedulePayoutRequestV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSchedulePayoutRequestV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
