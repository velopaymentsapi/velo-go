...
`func (o *PayeeDetailResponse) GetPayeeType() PayeeType`

GetPayeeType returns the PayeeType field if non-nil, zero value otherwise.

### GetPayeeTypeOk

`func (o *PayeeDetailResponse) GetPayeeTypeOk() (*PayeeType, bool)`
...
`func (o *PayeeDetailResponse) SetPayeeType(v PayeeType)`
