...
> string ExportTransactionsCSV(ctx, optional)
 ...
 **optional** | ***ExportTransactionsCSVOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a ExportTransactionsCSVOpts struct
...
> GetPayoutsResponseV3 GetPayoutsForPayor(ctx, payorId, optional)
 ...
 **optional** | ***GetPayoutsForPayorOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a GetPayoutsForPayorOpts struct
...
> GetPayoutsResponseV4 GetPayoutsForPayorV4(ctx, payorId, optional)
...
> ListPaymentsResponse ListPaymentsAuditV4(ctx, optional)
