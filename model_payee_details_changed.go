...
// checks if the PayeeDetailsChanged type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayeeDetailsChanged{}

// PayeeDetailsChanged Base type for all payee details changed events
type PayeeDetailsChanged struct {
...
func (o PayeeDetailsChanged) MarshalJSON() ([]byte, error) {
...
func (o PayeeDetailsChanged) ToMap() (map[string]interface{}, error) {
...
type NullablePayeeDetailsChanged struct {
	value *PayeeDetailsChanged
	isSet bool
}

func (v NullablePayeeDetailsChanged) Get() *PayeeDetailsChanged {
	return v.value
}

func (v *NullablePayeeDetailsChanged) Set(val *PayeeDetailsChanged) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeDetailsChanged) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeDetailsChanged) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeDetailsChanged(val *PayeeDetailsChanged) *NullablePayeeDetailsChanged {
	return &NullablePayeeDetailsChanged{value: val, isSet: true}
}

func (v NullablePayeeDetailsChanged) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeDetailsChanged) UnmarshalJSON(src []byte) error {
	v.isSet = true
