...
// checks if the GetPaymentsForPayoutResponseV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPaymentsForPayoutResponseV4{}
...
func NewGetPaymentsForPayoutResponseV4() *GetPaymentsForPayoutResponseV4 {
	this := GetPaymentsForPayoutResponseV4{}
	return &this
}
...
func (o *GetPaymentsForPayoutResponseV4) GetSummary() GetPaymentsForPayoutResponseV4Summary {
	if o == nil || IsNil(o.Summary) {
		var ret GetPaymentsForPayoutResponseV4Summary
		return ret
	}
	return *o.Summary
}
...
// SetSummary gets a reference to the given GetPaymentsForPayoutResponseV4Summary and assigns it to the Summary field.
...
func (o *GetPaymentsForPayoutResponseV4) GetPage() PagedPayeeInvitationStatusResponseV3Page {
	if o == nil || IsNil(o.Page) {
		var ret PagedPayeeInvitationStatusResponseV3Page
		return ret
	}
	return *o.Page
}
...
// SetPage gets a reference to the given PagedPayeeInvitationStatusResponseV3Page and assigns it to the Page field.
...
func (o GetPaymentsForPayoutResponseV4) MarshalJSON() ([]byte, error) {
...
func (o GetPaymentsForPayoutResponseV4) ToMap() (map[string]interface{}, error) {
...
type NullableGetPaymentsForPayoutResponseV4 struct {
	value *GetPaymentsForPayoutResponseV4
	isSet bool
}

func (v NullableGetPaymentsForPayoutResponseV4) Get() *GetPaymentsForPayoutResponseV4 {
	return v.value
}

func (v *NullableGetPaymentsForPayoutResponseV4) Set(val *GetPaymentsForPayoutResponseV4) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPaymentsForPayoutResponseV4) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPaymentsForPayoutResponseV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPaymentsForPayoutResponseV4(val *GetPaymentsForPayoutResponseV4) *NullableGetPaymentsForPayoutResponseV4 {
	return &NullableGetPaymentsForPayoutResponseV4{value: val, isSet: true}
}

func (v NullableGetPaymentsForPayoutResponseV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPaymentsForPayoutResponseV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
