...
func NewPayeeInvitationStatusResponse2(payeeId string, invitationStatus string) *PayeeInvitationStatusResponse2 {
	this := PayeeInvitationStatusResponse2{}
...
func (o *PayeeInvitationStatusResponse2) GetGracePeriodEndDate() string {
	if o == nil || o.GracePeriodEndDate == nil {
		var ret string
		return ret
	}
...
func (o PayeeInvitationStatusResponse2) MarshalJSON() ([]byte, error) {
	...
	if o.GracePeriodEndDate != nil {
		toSerialize["gracePeriodEndDate"] = o.GracePeriodEndDate
	}
	return json.Marshal(toSerialize)
}

type NullablePayeeInvitationStatusResponse2 struct {
	value *PayeeInvitationStatusResponse2
	isSet bool
}

func (v NullablePayeeInvitationStatusResponse2) Get() *PayeeInvitationStatusResponse2 {
	return v.value
}

func (v *NullablePayeeInvitationStatusResponse2) Set(val *PayeeInvitationStatusResponse2) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeInvitationStatusResponse2) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeInvitationStatusResponse2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeInvitationStatusResponse2(val *PayeeInvitationStatusResponse2) *NullablePayeeInvitationStatusResponse2 {
	return &NullablePayeeInvitationStatusResponse2{value: val, isSet: true}
}

func (v NullablePayeeInvitationStatusResponse2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeInvitationStatusResponse2) UnmarshalJSON(src []byte) error {
	v.isSet = true
