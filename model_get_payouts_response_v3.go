...
// checks if the GetPayoutsResponseV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPayoutsResponseV3{}
...
func (o *GetPayoutsResponseV3) GetPage() GetPayoutsResponseV3Page {
	if o == nil || IsNil(o.Page) {
		var ret GetPayoutsResponseV3Page
		return ret
	}
	return *o.Page
}
...
// SetPage gets a reference to the given GetPayoutsResponseV3Page and assigns it to the Page field.
...
// SetContent gets a reference to the given []PayoutSummaryAuditV3 and assigns it to the Content field.
func (o *GetPayoutsResponseV3) SetContent(v []PayoutSummaryAuditV3) {
	o.Content = v
}

func (o GetPayoutsResponseV3) MarshalJSON() ([]byte, error) {
...
func (o GetPayoutsResponseV3) ToMap() (map[string]interface{}, error) {
...
type NullableGetPayoutsResponseV3 struct {
	value *GetPayoutsResponseV3
	isSet bool
}

func (v NullableGetPayoutsResponseV3) Get() *GetPayoutsResponseV3 {
	return v.value
}

func (v *NullableGetPayoutsResponseV3) Set(val *GetPayoutsResponseV3) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPayoutsResponseV3) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPayoutsResponseV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPayoutsResponseV3(val *GetPayoutsResponseV3) *NullableGetPayoutsResponseV3 {
	return &NullableGetPayoutsResponseV3{value: val, isSet: true}
}

func (v NullableGetPayoutsResponseV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPayoutsResponseV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
