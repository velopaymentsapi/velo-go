...
func (o PayeePaymentChannel) MarshalJSON() ([]byte, error) {
...
type NullablePayeePaymentChannel struct {
	value *PayeePaymentChannel
	isSet bool
}

func (v NullablePayeePaymentChannel) Get() *PayeePaymentChannel {
	return v.value
}

func (v *NullablePayeePaymentChannel) Set(val *PayeePaymentChannel) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeePaymentChannel) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeePaymentChannel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeePaymentChannel(val *PayeePaymentChannel) *NullablePayeePaymentChannel {
	return &NullablePayeePaymentChannel{value: val, isSet: true}
}

func (v NullablePayeePaymentChannel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeePaymentChannel) UnmarshalJSON(src []byte) error {
	v.isSet = true
