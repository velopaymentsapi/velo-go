...
// checks if the PaymentDeltaResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentDeltaResponse{}
...
// SetContent gets a reference to the given []PaymentDelta and assigns it to the Content field.
func (o *PaymentDeltaResponse) SetContent(v []PaymentDelta) {
	o.Content = v
}

func (o PaymentDeltaResponse) MarshalJSON() ([]byte, error) {
...
func (o PaymentDeltaResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentDeltaResponse struct {
	value *PaymentDeltaResponse
	isSet bool
}

func (v NullablePaymentDeltaResponse) Get() *PaymentDeltaResponse {
	return v.value
}

func (v *NullablePaymentDeltaResponse) Set(val *PaymentDeltaResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentDeltaResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentDeltaResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentDeltaResponse(val *PaymentDeltaResponse) *NullablePaymentDeltaResponse {
	return &NullablePaymentDeltaResponse{value: val, isSet: true}
}

func (v NullablePaymentDeltaResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentDeltaResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
