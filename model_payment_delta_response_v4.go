...
// PaymentDeltaResponseV4 List Payment Changes Response Object
type PaymentDeltaResponseV4 struct {
	Page *PagedPayeeInvitationStatusResponsePage `json:"page,omitempty"`
	Links *[]PagedPayeeResponseLinks `json:"links,omitempty"`
	Content *[]PaymentDeltaV4 `json:"content,omitempty"`
}
...
// SetContent gets a reference to the given []PaymentDeltaV4 and assigns it to the Content field.
func (o *PaymentDeltaResponseV4) SetContent(v []PaymentDeltaV4) {
	o.Content = &v
}

func (o PaymentDeltaResponseV4) MarshalJSON() ([]byte, error) {
...
type NullablePaymentDeltaResponseV4 struct {
	value *PaymentDeltaResponseV4
	isSet bool
}

func (v NullablePaymentDeltaResponseV4) Get() *PaymentDeltaResponseV4 {
	return v.value
}

func (v *NullablePaymentDeltaResponseV4) Set(val *PaymentDeltaResponseV4) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentDeltaResponseV4) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentDeltaResponseV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentDeltaResponseV4(val *PaymentDeltaResponseV4) *NullablePaymentDeltaResponseV4 {
	return &NullablePaymentDeltaResponseV4{value: val, isSet: true}
}

func (v NullablePaymentDeltaResponseV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentDeltaResponseV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
