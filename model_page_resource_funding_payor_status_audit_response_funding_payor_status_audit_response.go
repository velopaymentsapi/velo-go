...
// checks if the PageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse{}
...
func NewPageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse() *PageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse {
	this := PageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse{}
	return &this
}
...
func (o *PageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse) GetContent() []FundingPayorStatusAuditResponse {
	if o == nil || IsNil(o.Content) {
		var ret []FundingPayorStatusAuditResponse
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []FundingPayorStatusAuditResponse and assigns it to the Content field.
...
func (o PageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse) MarshalJSON() ([]byte, error) {
...
func (o PageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse struct {
	value *PageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse
	isSet bool
}

func (v NullablePageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse) Get() *PageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse {
	return v.value
}

func (v *NullablePageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse) Set(val *PageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse(val *PageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse) *NullablePageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse {
	return &NullablePageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse{value: val, isSet: true}
}

func (v NullablePageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
