...
// SetFailures gets a reference to the given []FailedSubmission2 and assigns it to the Failures field.
func (o *QueryBatchResponse2) SetFailures(v []FailedSubmission2) {
	o.Failures = &v
}

func (o QueryBatchResponse2) MarshalJSON() ([]byte, error) {
...
type NullableQueryBatchResponse2 struct {
	value *QueryBatchResponse2
	isSet bool
}

func (v NullableQueryBatchResponse2) Get() *QueryBatchResponse2 {
	return v.value
}

func (v *NullableQueryBatchResponse2) Set(val *QueryBatchResponse2) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryBatchResponse2) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryBatchResponse2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryBatchResponse2(val *QueryBatchResponse2) *NullableQueryBatchResponse2 {
	return &NullableQueryBatchResponse2{value: val, isSet: true}
}

func (v NullableQueryBatchResponse2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryBatchResponse2) UnmarshalJSON(src []byte) error {
	v.isSet = true
