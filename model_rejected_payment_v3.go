...
type NullableRejectedPaymentV3 struct {
	value *RejectedPaymentV3
	isSet bool
}

func (v NullableRejectedPaymentV3) Get() *RejectedPaymentV3 {
	return v.value
}

func (v *NullableRejectedPaymentV3) Set(val *RejectedPaymentV3) {
	v.value = val
	v.isSet = true
}

func (v NullableRejectedPaymentV3) IsSet() bool {
	return v.isSet
}

func (v *NullableRejectedPaymentV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRejectedPaymentV3(val *RejectedPaymentV3) *NullableRejectedPaymentV3 {
	return &NullableRejectedPaymentV3{value: val, isSet: true}
}

func (v NullableRejectedPaymentV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRejectedPaymentV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
