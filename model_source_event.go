...
// checks if the SourceEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceEvent{}

// SourceEvent Base type for each source event payload
...
func (o SourceEvent) MarshalJSON() ([]byte, error) {
...
func (o SourceEvent) ToMap() (map[string]interface{}, error) {
...
type NullableSourceEvent struct {
	value *SourceEvent
	isSet bool
}

func (v NullableSourceEvent) Get() *SourceEvent {
	return v.value
}

func (v *NullableSourceEvent) Set(val *SourceEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableSourceEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableSourceEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSourceEvent(val *SourceEvent) *NullableSourceEvent {
	return &NullableSourceEvent{value: val, isSet: true}
}

func (v NullableSourceEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSourceEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
