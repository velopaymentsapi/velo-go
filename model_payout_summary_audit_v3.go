...
// checks if the PayoutSummaryAuditV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayoutSummaryAuditV3{}
...
func (o *PayoutSummaryAuditV3) GetTotalFailedPayments() int32 {
	if o == nil || IsNil(o.TotalFailedPayments) {
		var ret int32
		return ret
	}
...
func (o PayoutSummaryAuditV3) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TotalFailedPayments) {
