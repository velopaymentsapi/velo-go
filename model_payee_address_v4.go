...
// checks if the PayeeAddressV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayeeAddressV4{}

// PayeeAddressV4 struct for PayeeAddressV4
...
func (o *PayeeAddressV4) SetLine2Nil() {
	o.Line2.Set(nil)
}
...
func (o *PayeeAddressV4) SetLine3Nil() {
	o.Line3.Set(nil)
}
...
func (o *PayeeAddressV4) SetLine4Nil() {
	o.Line4.Set(nil)
}
...
func (o *PayeeAddressV4) SetCountyOrProvinceNil() {
...
func (o *PayeeAddressV4) SetZipOrPostcodeNil() {
...
func (o PayeeAddressV4) MarshalJSON() ([]byte, error) {
...
func (o PayeeAddressV4) ToMap() (map[string]interface{}, error) {
...
type NullablePayeeAddressV4 struct {
	value *PayeeAddressV4
	isSet bool
}

func (v NullablePayeeAddressV4) Get() *PayeeAddressV4 {
	return v.value
}

func (v *NullablePayeeAddressV4) Set(val *PayeeAddressV4) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeAddressV4) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeAddressV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeAddressV4(val *PayeeAddressV4) *NullablePayeeAddressV4 {
	return &NullablePayeeAddressV4{value: val, isSet: true}
}

func (v NullablePayeeAddressV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeAddressV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
