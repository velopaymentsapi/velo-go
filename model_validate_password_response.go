...
// checks if the ValidatePasswordResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValidatePasswordResponse{}
...
func (o ValidatePasswordResponse) MarshalJSON() ([]byte, error) {
...
func (o ValidatePasswordResponse) ToMap() (map[string]interface{}, error) {
...
type NullableValidatePasswordResponse struct {
	value *ValidatePasswordResponse
	isSet bool
}

func (v NullableValidatePasswordResponse) Get() *ValidatePasswordResponse {
	return v.value
}

func (v *NullableValidatePasswordResponse) Set(val *ValidatePasswordResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableValidatePasswordResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableValidatePasswordResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidatePasswordResponse(val *ValidatePasswordResponse) *NullableValidatePasswordResponse {
	return &NullableValidatePasswordResponse{value: val, isSet: true}
}

func (v NullableValidatePasswordResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidatePasswordResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
