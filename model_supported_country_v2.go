...
// checks if the SupportedCountryV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportedCountryV2{}
...
func (o SupportedCountryV2) ToMap() (map[string]interface{}, error) {
