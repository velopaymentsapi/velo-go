...
// checks if the PageForResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageForResponse{}
...
func (o PageForResponse) ToMap() (map[string]interface{}, error) {
