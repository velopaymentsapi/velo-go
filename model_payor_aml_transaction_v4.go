...
func (o PayorAmlTransactionV4) MarshalJSON() ([]byte, error) {
...
type NullablePayorAmlTransactionV4 struct {
	value *PayorAmlTransactionV4
	isSet bool
}

func (v NullablePayorAmlTransactionV4) Get() *PayorAmlTransactionV4 {
	return v.value
}

func (v *NullablePayorAmlTransactionV4) Set(val *PayorAmlTransactionV4) {
	v.value = val
	v.isSet = true
}

func (v NullablePayorAmlTransactionV4) IsSet() bool {
	return v.isSet
}

func (v *NullablePayorAmlTransactionV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayorAmlTransactionV4(val *PayorAmlTransactionV4) *NullablePayorAmlTransactionV4 {
	return &NullablePayorAmlTransactionV4{value: val, isSet: true}
}

func (v NullablePayorAmlTransactionV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayorAmlTransactionV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
