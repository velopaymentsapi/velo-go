...
// PayoutSchedule2 Details relating to a payout that was executed via a schedule or is still waiting to be executed
type PayoutSchedule2 struct {
	ScheduleStatus ScheduleStatus2 `json:"scheduleStatus"`
...
func (o PayoutSchedule2) MarshalJSON() ([]byte, error) {
...
type NullablePayoutSchedule2 struct {
	value *PayoutSchedule2
	isSet bool
}

func (v NullablePayoutSchedule2) Get() *PayoutSchedule2 {
	return v.value
}

func (v *NullablePayoutSchedule2) Set(val *PayoutSchedule2) {
	v.value = val
	v.isSet = true
}

func (v NullablePayoutSchedule2) IsSet() bool {
	return v.isSet
}

func (v *NullablePayoutSchedule2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayoutSchedule2(val *PayoutSchedule2) *NullablePayoutSchedule2 {
	return &NullablePayoutSchedule2{value: val, isSet: true}
}

func (v NullablePayoutSchedule2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayoutSchedule2) UnmarshalJSON(src []byte) error {
	v.isSet = true
