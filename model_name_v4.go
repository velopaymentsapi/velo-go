...
// checks if the NameV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NameV4{}

// NameV4 struct for NameV4
type NameV4 struct {
...
func (o NameV4) MarshalJSON() ([]byte, error) {
...
func (o NameV4) ToMap() (map[string]interface{}, error) {
...
type NullableNameV4 struct {
	value *NameV4
	isSet bool
}

func (v NullableNameV4) Get() *NameV4 {
	return v.value
}

func (v *NullableNameV4) Set(val *NameV4) {
	v.value = val
	v.isSet = true
}

func (v NullableNameV4) IsSet() bool {
	return v.isSet
}

func (v *NullableNameV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNameV4(val *NameV4) *NullableNameV4 {
	return &NullableNameV4{value: val, isSet: true}
}

func (v NullableNameV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNameV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
