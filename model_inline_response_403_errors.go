...
func (o InlineResponse403Errors) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse403Errors struct {
	value *InlineResponse403Errors
	isSet bool
}

func (v NullableInlineResponse403Errors) Get() *InlineResponse403Errors {
	return v.value
}

func (v *NullableInlineResponse403Errors) Set(val *InlineResponse403Errors) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse403Errors) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse403Errors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse403Errors(val *InlineResponse403Errors) *NullableInlineResponse403Errors {
	return &NullableInlineResponse403Errors{value: val, isSet: true}
}

func (v NullableInlineResponse403Errors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse403Errors) UnmarshalJSON(src []byte) error {
	v.isSet = true
