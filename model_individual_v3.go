...
// checks if the IndividualV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IndividualV3{}

// IndividualV3 struct for IndividualV3
...
func (o IndividualV3) MarshalJSON() ([]byte, error) {
...
func (o IndividualV3) ToMap() (map[string]interface{}, error) {
...
type NullableIndividualV3 struct {
	value *IndividualV3
	isSet bool
}

func (v NullableIndividualV3) Get() *IndividualV3 {
	return v.value
}

func (v *NullableIndividualV3) Set(val *IndividualV3) {
	v.value = val
	v.isSet = true
}

func (v NullableIndividualV3) IsSet() bool {
	return v.isSet
}

func (v *NullableIndividualV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIndividualV3(val *IndividualV3) *NullableIndividualV3 {
	return &NullableIndividualV3{value: val, isSet: true}
}

func (v NullableIndividualV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIndividualV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
