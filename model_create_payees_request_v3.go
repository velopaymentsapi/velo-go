...
// checks if the CreatePayeesRequestV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePayeesRequestV3{}

// CreatePayeesRequestV3 struct for CreatePayeesRequestV3
type CreatePayeesRequestV3 struct {
	PayorId string `json:"payorId"`
	Payees []CreatePayeeV3 `json:"payees"`
}
...
func (o CreatePayeesRequestV3) MarshalJSON() ([]byte, error) {
...
func (o CreatePayeesRequestV3) ToMap() (map[string]interface{}, error) {
...
type NullableCreatePayeesRequestV3 struct {
	value *CreatePayeesRequestV3
	isSet bool
}

func (v NullableCreatePayeesRequestV3) Get() *CreatePayeesRequestV3 {
	return v.value
}

func (v *NullableCreatePayeesRequestV3) Set(val *CreatePayeesRequestV3) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePayeesRequestV3) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePayeesRequestV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePayeesRequestV3(val *CreatePayeesRequestV3) *NullableCreatePayeesRequestV3 {
	return &NullableCreatePayeesRequestV3{value: val, isSet: true}
}

func (v NullableCreatePayeesRequestV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePayeesRequestV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
