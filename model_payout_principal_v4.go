...
func (o PayoutPrincipalV4) MarshalJSON() ([]byte, error) {
...
type NullablePayoutPrincipalV4 struct {
	value *PayoutPrincipalV4
	isSet bool
}

func (v NullablePayoutPrincipalV4) Get() *PayoutPrincipalV4 {
	return v.value
}

func (v *NullablePayoutPrincipalV4) Set(val *PayoutPrincipalV4) {
	v.value = val
	v.isSet = true
}

func (v NullablePayoutPrincipalV4) IsSet() bool {
	return v.isSet
}

func (v *NullablePayoutPrincipalV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayoutPrincipalV4(val *PayoutPrincipalV4) *NullablePayoutPrincipalV4 {
	return &NullablePayoutPrincipalV4{value: val, isSet: true}
}

func (v NullablePayoutPrincipalV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayoutPrincipalV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
