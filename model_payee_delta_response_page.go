...
func (o PayeeDeltaResponsePage) MarshalJSON() ([]byte, error) {
...
type NullablePayeeDeltaResponsePage struct {
	value *PayeeDeltaResponsePage
	isSet bool
}

func (v NullablePayeeDeltaResponsePage) Get() *PayeeDeltaResponsePage {
	return v.value
}

func (v *NullablePayeeDeltaResponsePage) Set(val *PayeeDeltaResponsePage) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeDeltaResponsePage) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeDeltaResponsePage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeDeltaResponsePage(val *PayeeDeltaResponsePage) *NullablePayeeDeltaResponsePage {
	return &NullablePayeeDeltaResponsePage{value: val, isSet: true}
}

func (v NullablePayeeDeltaResponsePage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeDeltaResponsePage) UnmarshalJSON(src []byte) error {
	v.isSet = true
