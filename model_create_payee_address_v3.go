...
// checks if the CreatePayeeAddressV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePayeeAddressV3{}

// CreatePayeeAddressV3 struct for CreatePayeeAddressV3
...
func (o *CreatePayeeAddressV3) SetLine2Nil() {
	o.Line2.Set(nil)
}
...
func (o *CreatePayeeAddressV3) HasLine3() bool {
...
func (o *CreatePayeeAddressV3) SetLine3Nil() {
	o.Line3.Set(nil)
}
...
func (o *CreatePayeeAddressV3) SetLine4Nil() {
	o.Line4.Set(nil)
}
...
// and a boolean to check if the value has been set.
func (o *CreatePayeeAddressV3) GetCityOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.City, true
...
func (o *CreatePayeeAddressV3) SetCountyOrProvinceNil() {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CreatePayeeAddressV3) GetZipOrPostcodeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreatePayeeAddressV3) SetZipOrPostcodeNil() {
...
func (o CreatePayeeAddressV3) MarshalJSON() ([]byte, error) {
...
func (o CreatePayeeAddressV3) ToMap() (map[string]interface{}, error) {
...
type NullableCreatePayeeAddressV3 struct {
	value *CreatePayeeAddressV3
	isSet bool
}

func (v NullableCreatePayeeAddressV3) Get() *CreatePayeeAddressV3 {
	return v.value
}

func (v *NullableCreatePayeeAddressV3) Set(val *CreatePayeeAddressV3) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePayeeAddressV3) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePayeeAddressV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePayeeAddressV3(val *CreatePayeeAddressV3) *NullableCreatePayeeAddressV3 {
	return &NullableCreatePayeeAddressV3{value: val, isSet: true}
}

func (v NullableCreatePayeeAddressV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePayeeAddressV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
