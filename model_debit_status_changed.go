...
// checks if the DebitStatusChanged type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DebitStatusChanged{}

// DebitStatusChanged Base type for all debit status changed events
type DebitStatusChanged struct {
...
// GetDebitTransactionId returns the DebitTransactionId field value
func (o *DebitStatusChanged) GetDebitTransactionId() string {
	...
	return o.DebitTransactionId
}

// GetDebitTransactionIdOk returns a tuple with the DebitTransactionId field value
// and a boolean to check if the value has been set.
func (o *DebitStatusChanged) GetDebitTransactionIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.DebitTransactionId, true
}

// SetDebitTransactionId sets field value
func (o *DebitStatusChanged) SetDebitTransactionId(v string) {
	o.DebitTransactionId = v
}
...
func (o DebitStatusChanged) MarshalJSON() ([]byte, error) {
...
func (o DebitStatusChanged) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["sourceType"] = o.SourceType
	toSerialize["eventId"] = o.EventId
	toSerialize["createdAt"] = o.CreatedAt
	toSerialize["debitTransactionId"] = o.DebitTransactionId
	toSerialize["status"] = o.Status
	return toSerialize, nil
}

type NullableDebitStatusChanged struct {
	value *DebitStatusChanged
	isSet bool
}

func (v NullableDebitStatusChanged) Get() *DebitStatusChanged {
	return v.value
}

func (v *NullableDebitStatusChanged) Set(val *DebitStatusChanged) {
	v.value = val
	v.isSet = true
}

func (v NullableDebitStatusChanged) IsSet() bool {
	return v.isSet
}

func (v *NullableDebitStatusChanged) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDebitStatusChanged(val *DebitStatusChanged) *NullableDebitStatusChanged {
	return &NullableDebitStatusChanged{value: val, isSet: true}
}

func (v NullableDebitStatusChanged) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDebitStatusChanged) UnmarshalJSON(src []byte) error {
	v.isSet = true
