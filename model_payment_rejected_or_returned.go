...
// checks if the PaymentRejectedOrReturned type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentRejectedOrReturned{}
...
func (o *PaymentRejectedOrReturned) GetPayoutPayorIds() PayoutPayorIds {
	if o == nil || IsNil(o.PayoutPayorIds) {
...
func (o PaymentRejectedOrReturned) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["sourceType"] = o.SourceType
	toSerialize["eventId"] = o.EventId
	toSerialize["createdAt"] = o.CreatedAt
	toSerialize["paymentId"] = o.PaymentId
	if !IsNil(o.PayoutPayorIds) {
