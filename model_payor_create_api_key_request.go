...
// checks if the PayorCreateApiKeyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayorCreateApiKeyRequest{}
...
func (o *PayorCreateApiKeyRequest) SetDescriptionNil() {
...
func (o PayorCreateApiKeyRequest) MarshalJSON() ([]byte, error) {
...
func (o PayorCreateApiKeyRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePayorCreateApiKeyRequest struct {
	value *PayorCreateApiKeyRequest
	isSet bool
}

func (v NullablePayorCreateApiKeyRequest) Get() *PayorCreateApiKeyRequest {
	return v.value
}

func (v *NullablePayorCreateApiKeyRequest) Set(val *PayorCreateApiKeyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePayorCreateApiKeyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePayorCreateApiKeyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayorCreateApiKeyRequest(val *PayorCreateApiKeyRequest) *NullablePayorCreateApiKeyRequest {
	return &NullablePayorCreateApiKeyRequest{value: val, isSet: true}
}

func (v NullablePayorCreateApiKeyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayorCreateApiKeyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
