...
// checks if the CreateIndividualV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateIndividualV3{}

// CreateIndividualV3 struct for CreateIndividualV3
...
func (o *CreateIndividualV3) GetName() CreateIndividualV3Name {
	if o == nil {
		var ret CreateIndividualV3Name
		return ret
	}
...
// SetNationalIdentification gets a reference to the given string and assigns it to the NationalIdentification field.
...
func (o CreateIndividualV3) MarshalJSON() ([]byte, error) {
...
func (o CreateIndividualV3) ToMap() (map[string]interface{}, error) {
...
type NullableCreateIndividualV3 struct {
	value *CreateIndividualV3
	isSet bool
}

func (v NullableCreateIndividualV3) Get() *CreateIndividualV3 {
	return v.value
}

func (v *NullableCreateIndividualV3) Set(val *CreateIndividualV3) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateIndividualV3) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateIndividualV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateIndividualV3(val *CreateIndividualV3) *NullableCreateIndividualV3 {
	return &NullableCreateIndividualV3{value: val, isSet: true}
}

func (v NullableCreateIndividualV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateIndividualV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
