...
// checks if the UnregisterMFARequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnregisterMFARequest{}
...
func (o UnregisterMFARequest) ToMap() (map[string]interface{}, error) {
