...
// InlineResponse412Errors struct for InlineResponse412Errors
type InlineResponse412Errors struct {
...
func (o InlineResponse412Errors) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse412Errors struct {
	value *InlineResponse412Errors
	isSet bool
}

func (v NullableInlineResponse412Errors) Get() *InlineResponse412Errors {
	return v.value
}

func (v *NullableInlineResponse412Errors) Set(val *InlineResponse412Errors) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse412Errors) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse412Errors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse412Errors(val *InlineResponse412Errors) *NullableInlineResponse412Errors {
	return &NullableInlineResponse412Errors{value: val, isSet: true}
}

func (v NullableInlineResponse412Errors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse412Errors) UnmarshalJSON(src []byte) error {
	v.isSet = true
