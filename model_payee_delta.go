...
func (o PayeeDelta) MarshalJSON() ([]byte, error) {
...
type NullablePayeeDelta struct {
	value *PayeeDelta
	isSet bool
}

func (v NullablePayeeDelta) Get() *PayeeDelta {
	return v.value
}

func (v *NullablePayeeDelta) Set(val *PayeeDelta) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeDelta) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeDelta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeDelta(val *PayeeDelta) *NullablePayeeDelta {
	return &NullablePayeeDelta{value: val, isSet: true}
}

func (v NullablePayeeDelta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeDelta) UnmarshalJSON(src []byte) error {
	v.isSet = true
