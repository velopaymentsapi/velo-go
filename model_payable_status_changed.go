...
// checks if the PayableStatusChanged type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayableStatusChanged{}

// PayableStatusChanged Base type for all payable status changed events
type PayableStatusChanged struct {
...
func (o PayableStatusChanged) MarshalJSON() ([]byte, error) {
...
func (o PayableStatusChanged) ToMap() (map[string]interface{}, error) {
...
type NullablePayableStatusChanged struct {
	value *PayableStatusChanged
	isSet bool
}

func (v NullablePayableStatusChanged) Get() *PayableStatusChanged {
	return v.value
}

func (v *NullablePayableStatusChanged) Set(val *PayableStatusChanged) {
	v.value = val
	v.isSet = true
}

func (v NullablePayableStatusChanged) IsSet() bool {
	return v.isSet
}

func (v *NullablePayableStatusChanged) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayableStatusChanged(val *PayableStatusChanged) *NullablePayableStatusChanged {
	return &NullablePayableStatusChanged{value: val, isSet: true}
}

func (v NullablePayableStatusChanged) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayableStatusChanged) UnmarshalJSON(src []byte) error {
	v.isSet = true
