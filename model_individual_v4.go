...
// checks if the IndividualV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IndividualV4{}

// IndividualV4 struct for IndividualV4
...
func (o IndividualV4) MarshalJSON() ([]byte, error) {
...
func (o IndividualV4) ToMap() (map[string]interface{}, error) {
...
type NullableIndividualV4 struct {
	value *IndividualV4
	isSet bool
}

func (v NullableIndividualV4) Get() *IndividualV4 {
	return v.value
}

func (v *NullableIndividualV4) Set(val *IndividualV4) {
	v.value = val
	v.isSet = true
}

func (v NullableIndividualV4) IsSet() bool {
	return v.isSet
}

func (v *NullableIndividualV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIndividualV4(val *IndividualV4) *NullableIndividualV4 {
	return &NullableIndividualV4{value: val, isSet: true}
}

func (v NullableIndividualV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIndividualV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
