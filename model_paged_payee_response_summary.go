...
// GetTotalOfacFailedCount returns the TotalOfacFailedCount field value if set, zero value otherwise.
func (o *PagedPayeeResponseSummary) GetTotalOfacFailedCount() int32 {
	if o == nil || o.TotalOfacFailedCount == nil {
		var ret int32
		return ret
	}
	return *o.TotalOfacFailedCount
}

// GetTotalOfacFailedCountOk returns a tuple with the TotalOfacFailedCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PagedPayeeResponseSummary) GetTotalOfacFailedCountOk() (*int32, bool) {
	if o == nil || o.TotalOfacFailedCount == nil {
		return nil, false
	}
	return o.TotalOfacFailedCount, true
}
...
// SetTotalOfacFailedCount gets a reference to the given int32 and assigns it to the TotalOfacFailedCount field.
func (o *PagedPayeeResponseSummary) SetTotalOfacFailedCount(v int32) {
	o.TotalOfacFailedCount = &v
}
...
func (o PagedPayeeResponseSummary) MarshalJSON() ([]byte, error) {
	...
	if o.TotalOfacFailedCount != nil {
		toSerialize["totalOfacFailedCount"] = o.TotalOfacFailedCount
	}
