...
// checks if the ListPaymentsResponseV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListPaymentsResponseV4{}
...
func (o ListPaymentsResponseV4) ToMap() (map[string]interface{}, error) {
