...
// checks if the CommonPageObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonPageObject{}

// CommonPageObject struct for CommonPageObject
type CommonPageObject struct {
...
func (o CommonPageObject) MarshalJSON() ([]byte, error) {
...
func (o CommonPageObject) ToMap() (map[string]interface{}, error) {
...
type NullableCommonPageObject struct {
	value *CommonPageObject
	isSet bool
}

func (v NullableCommonPageObject) Get() *CommonPageObject {
	return v.value
}

func (v *NullableCommonPageObject) Set(val *CommonPageObject) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonPageObject) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonPageObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonPageObject(val *CommonPageObject) *NullableCommonPageObject {
	return &NullableCommonPageObject{value: val, isSet: true}
}

func (v NullableCommonPageObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonPageObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
