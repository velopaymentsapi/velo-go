...
func (o IndividualV1) MarshalJSON() ([]byte, error) {
...
type NullableIndividualV1 struct {
	value *IndividualV1
	isSet bool
}

func (v NullableIndividualV1) Get() *IndividualV1 {
	return v.value
}

func (v *NullableIndividualV1) Set(val *IndividualV1) {
	v.value = val
	v.isSet = true
}

func (v NullableIndividualV1) IsSet() bool {
	return v.isSet
}

func (v *NullableIndividualV1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIndividualV1(val *IndividualV1) *NullableIndividualV1 {
	return &NullableIndividualV1{value: val, isSet: true}
}

func (v NullableIndividualV1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIndividualV1) UnmarshalJSON(src []byte) error {
	v.isSet = true
