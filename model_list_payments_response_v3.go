...
// checks if the ListPaymentsResponseV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListPaymentsResponseV3{}
...
func (o ListPaymentsResponseV3) MarshalJSON() ([]byte, error) {
...
func (o ListPaymentsResponseV3) ToMap() (map[string]interface{}, error) {
...
type NullableListPaymentsResponseV3 struct {
	value *ListPaymentsResponseV3
	isSet bool
}

func (v NullableListPaymentsResponseV3) Get() *ListPaymentsResponseV3 {
	return v.value
}

func (v *NullableListPaymentsResponseV3) Set(val *ListPaymentsResponseV3) {
	v.value = val
	v.isSet = true
}

func (v NullableListPaymentsResponseV3) IsSet() bool {
	return v.isSet
}

func (v *NullableListPaymentsResponseV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListPaymentsResponseV3(val *ListPaymentsResponseV3) *NullableListPaymentsResponseV3 {
	return &NullableListPaymentsResponseV3{value: val, isSet: true}
}

func (v NullableListPaymentsResponseV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListPaymentsResponseV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
