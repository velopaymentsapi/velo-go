...
func NewListFundingAccountsResponse2() *ListFundingAccountsResponse2 {
	this := ListFundingAccountsResponse2{}
	return &this
}
...
func (o *ListFundingAccountsResponse2) GetPage() ListSourceAccountResponsePage {
	if o == nil || o.Page == nil {
		var ret ListSourceAccountResponsePage
		return ret
	}
	return *o.Page
}
...
// SetPage gets a reference to the given ListSourceAccountResponsePage and assigns it to the Page field.
...
func (o *ListFundingAccountsResponse2) GetLinks() []ListSourceAccountResponseLinks {
	if o == nil || o.Links == nil {
		var ret []ListSourceAccountResponseLinks
		return ret
	}
	return o.Links
}
...
// SetLinks gets a reference to the given []ListSourceAccountResponseLinks and assigns it to the Links field.
...
func (o *ListFundingAccountsResponse2) GetContent() []FundingAccountResponse2 {
	if o == nil || o.Content == nil {
		var ret []FundingAccountResponse2
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []FundingAccountResponse2 and assigns it to the Content field.
func (o *ListFundingAccountsResponse2) SetContent(v []FundingAccountResponse2) {
	o.Content = v
}

func (o ListFundingAccountsResponse2) MarshalJSON() ([]byte, error) {
...
type NullableListFundingAccountsResponse2 struct {
	value *ListFundingAccountsResponse2
	isSet bool
}

func (v NullableListFundingAccountsResponse2) Get() *ListFundingAccountsResponse2 {
	return v.value
}

func (v *NullableListFundingAccountsResponse2) Set(val *ListFundingAccountsResponse2) {
	v.value = val
	v.isSet = true
}

func (v NullableListFundingAccountsResponse2) IsSet() bool {
	return v.isSet
}

func (v *NullableListFundingAccountsResponse2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListFundingAccountsResponse2(val *ListFundingAccountsResponse2) *NullableListFundingAccountsResponse2 {
	return &NullableListFundingAccountsResponse2{value: val, isSet: true}
}

func (v NullableListFundingAccountsResponse2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListFundingAccountsResponse2) UnmarshalJSON(src []byte) error {
	v.isSet = true
