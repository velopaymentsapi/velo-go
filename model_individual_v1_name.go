...
func (o IndividualV1Name) MarshalJSON() ([]byte, error) {
...
type NullableIndividualV1Name struct {
	value *IndividualV1Name
	isSet bool
}

func (v NullableIndividualV1Name) Get() *IndividualV1Name {
	return v.value
}

func (v *NullableIndividualV1Name) Set(val *IndividualV1Name) {
	v.value = val
	v.isSet = true
}

func (v NullableIndividualV1Name) IsSet() bool {
	return v.isSet
}

func (v *NullableIndividualV1Name) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIndividualV1Name(val *IndividualV1Name) *NullableIndividualV1Name {
	return &NullableIndividualV1Name{value: val, isSet: true}
}

func (v NullableIndividualV1Name) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIndividualV1Name) UnmarshalJSON(src []byte) error {
	v.isSet = true
