...
func (a *FundingManagerApiService) GetFundingAccount(ctx _context.Context, fundingAccountId string, localVarOptionals *GetFundingAccountOpts) (FundingAccountResponse, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"fundingAccountId"+"}", _neturl.QueryEscape(parameterToString(fundingAccountId, "")) , -1)
...
func (a *FundingManagerApiService) GetFundingAccounts(ctx _context.Context, localVarOptionals *GetFundingAccountsOpts) (ListFundingAccountsResponse, *_nethttp.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v ListFundingAccountsResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
*/
func (a *FundingManagerApiService) GetFundingsV1(ctx _context.Context, localVarOptionals *GetFundingsV1Opts) (GetFundingsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *FundingManagerApiService) ListFundingAuditDeltas(ctx _context.Context, payorId string, updatedSince time.Time, localVarOptionals *ListFundingAuditDeltasOpts) (PageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse, *_nethttp.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v PageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
