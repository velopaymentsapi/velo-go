 ...
 * @param fundingRequestV1 Body to included amount to be funded
*/
func (a *FundingManagerApiService) CreateAchFundingRequest(ctx _context.Context, sourceAccountId string, fundingRequestV1 FundingRequestV1) (*_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"sourceAccountId"+"}", _neturl.PathEscape(parameterToString(sourceAccountId, "")) , -1)
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param sourceAccountId Source account id
 * @param fundingRequestV2 Body to included amount to be funded
*/
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param sourceAccountId Source account id
 * @param fundingRequestV3 Body to included amount to be funded
*/
func (a *FundingManagerApiService) CreateFundingRequestV3(ctx _context.Context, sourceAccountId string, fundingRequestV3 FundingRequestV3) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/sourceAccounts/{sourceAccountId}/fundingRequest"
	localVarPath = strings.Replace(localVarPath, "{"+"sourceAccountId"+"}", _neturl.PathEscape(parameterToString(sourceAccountId, "")) , -1)
	...
	// body params
	localVarPostBody = &fundingRequestV3
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
...
func (a *FundingManagerApiService) GetFundingAccount(ctx _context.Context, fundingAccountId string, localVarOptionals *GetFundingAccountOpts) (FundingAccountResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/fundingAccounts/{fundingAccountId}"
	localVarPath = strings.Replace(localVarPath, "{"+"fundingAccountId"+"}", _neturl.PathEscape(parameterToString(fundingAccountId, "")) , -1)
...
// GetFundingAccountV2Opts Optional parameters for the method 'GetFundingAccountV2'
type GetFundingAccountV2Opts struct {
    Sensitive optional.Bool
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param fundingAccountId
 * @param optional nil or *GetFundingAccountV2Opts - Optional Parameters:
 * @param "Sensitive" (optional.Bool) - 
@return FundingAccountResponse2
*/
func (a *FundingManagerApiService) GetFundingAccountV2(ctx _context.Context, fundingAccountId string, localVarOptionals *GetFundingAccountV2Opts) (FundingAccountResponse2, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/fundingAccounts/{fundingAccountId}"
	localVarPath = strings.Replace(localVarPath, "{"+"fundingAccountId"+"}", _neturl.PathEscape(parameterToString(fundingAccountId, "")) , -1)
 ...
 * @param "Sort" (optional.String) -  List of sort fields (e.g. ?sort=accountName:asc,name:asc) Default is accountName:asc The supported sort fields are - accountName, name and currency.
 * @param "Sensitive" (optional.Bool) - 
@return ListFundingAccountsResponse
*/
func (a *FundingManagerApiService) GetFundingAccounts(ctx _context.Context, localVarOptionals *GetFundingAccountsOpts) (ListFundingAccountsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/fundingAccounts"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	...
	if localVarOptionals != nil && localVarOptionals.SourceAccountId.IsSet() {
		localVarQueryParams.Add("sourceAccountId", parameterToString(localVarOptionals.SourceAccountId.Value(), ""))
	}
...
// GetFundingAccountsV2Opts Optional parameters for the method 'GetFundingAccountsV2'
type GetFundingAccountsV2Opts struct {
    PayorId optional.Interface
...
Get the funding accounts.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetFundingAccountsV2Opts - Optional Parameters:
 * @param "PayorId" (optional.Interface of string) - 
 * @param "Name" (optional.String) -  The descriptive funding account name
 * @param "Country" (optional.String) -  The 2 letter ISO 3166-1 country code (upper case)
 * @param "Currency" (optional.String) -  The ISO 4217 currency code
 * @param "Type_" (optional.Interface of FundingAccountType) -  The type of funding account.
 * @param "Page" (optional.Int32) -  Page number. Default is 1.
 * @param "PageSize" (optional.Int32) -  The number of results to return in a page
 * @param "Sort" (optional.String) -  List of sort fields (e.g. ?sort=accountName:asc,name:asc) Default is accountName:asc The supported sort fields are - accountName, name.
 * @param "Sensitive" (optional.Bool) - 
@return ListFundingAccountsResponse2
*/
func (a *FundingManagerApiService) GetFundingAccountsV2(ctx _context.Context, localVarOptionals *GetFundingAccountsV2Opts) (ListFundingAccountsResponse2, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/fundingAccounts"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
*/
func (a *FundingManagerApiService) GetSourceAccountV3(ctx _context.Context, sourceAccountId string) (SourceAccountResponseV3, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/sourceAccounts/{sourceAccountId}"
	localVarPath = strings.Replace(localVarPath, "{"+"sourceAccountId"+"}", _neturl.PathEscape(parameterToString(sourceAccountId, "")) , -1)
...
func (a *FundingManagerApiService) GetSourceAccountsV2(ctx _context.Context, localVarOptionals *GetSourceAccountsV2Opts) (ListSourceAccountResponseV2, *_nethttp.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.PhysicalAccountId.IsSet() {
		localVarQueryParams.Add("physicalAccountId", parameterToString(localVarOptionals.PhysicalAccountId.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.PayorId.IsSet() {
		localVarQueryParams.Add("payorId", parameterToString(localVarOptionals.PayorId.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.FundingAccountId.IsSet() {
		localVarQueryParams.Add("fundingAccountId", parameterToString(localVarOptionals.FundingAccountId.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.Page.IsSet() {
		localVarQueryParams.Add("page", parameterToString(localVarOptionals.Page.Value(), ""))
	}
...
// GetSourceAccountsV3Opts Optional parameters for the method 'GetSourceAccountsV3'
type GetSourceAccountsV3Opts struct {
    PhysicalAccountName optional.String
    PhysicalAccountId optional.Interface
    PayorId optional.Interface
    FundingAccountId optional.Interface
...
List source accounts.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetSourceAccountsV3Opts - Optional Parameters:
 * @param "PhysicalAccountName" (optional.String) -  Physical Account Name
 * @param "PhysicalAccountId" (optional.Interface of string) -  The physical account ID
 * @param "PayorId" (optional.Interface of string) -  The account owner Payor ID
 * @param "FundingAccountId" (optional.Interface of string) -  The funding account ID
 * @param "Type_" (optional.Interface of SourceAccountType) -  The type of source account.
 * @param "Page" (optional.Int32) -  Page number. Default is 1.
 * @param "PageSize" (optional.Int32) -  The number of results to return in a page
 * @param "Sort" (optional.String) -  List of sort fields e.g. ?sort=name:asc Default is name:asc The supported sort fields are - fundingRef, name, balance 
@return ListSourceAccountResponseV3
*/
func (a *FundingManagerApiService) GetSourceAccountsV3(ctx _context.Context, localVarOptionals *GetSourceAccountsV3Opts) (ListSourceAccountResponseV3, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/sourceAccounts"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
*/
func (a *FundingManagerApiService) ListFundingAuditDeltas(ctx _context.Context, payorId string, updatedSince time.Time, localVarOptionals *ListFundingAuditDeltasOpts) (PageResourceFundingPayorStatusAuditResponseFundingPayorStatusAuditResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *FundingManagerApiService) TransferFunds(ctx _context.Context, sourceAccountId string, transferRequest TransferRequest) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/sourceAccounts/{sourceAccountId}/transfers"
	localVarPath = strings.Replace(localVarPath, "{"+"sourceAccountId"+"}", _neturl.PathEscape(parameterToString(sourceAccountId, "")) , -1)
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param sourceAccountId The 'from' source account id, which will be debited
 * @param transferRequest2 Body
*/
func (a *FundingManagerApiService) TransferFundsV3(ctx _context.Context, sourceAccountId string, transferRequest2 TransferRequest2) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/sourceAccounts/{sourceAccountId}/transfers"
	localVarPath = strings.Replace(localVarPath, "{"+"sourceAccountId"+"}", _neturl.PathEscape(parameterToString(sourceAccountId, "")) , -1)
	...
	// body params
	localVarPostBody = &transferRequest2
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
