...
// checks if the PaymentEventResponseV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentEventResponseV3{}
...
func (o PaymentEventResponseV3) MarshalJSON() ([]byte, error) {
...
func (o PaymentEventResponseV3) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentEventResponseV3 struct {
	value *PaymentEventResponseV3
	isSet bool
}

func (v NullablePaymentEventResponseV3) Get() *PaymentEventResponseV3 {
	return v.value
}

func (v *NullablePaymentEventResponseV3) Set(val *PaymentEventResponseV3) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentEventResponseV3) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentEventResponseV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentEventResponseV3(val *PaymentEventResponseV3) *NullablePaymentEventResponseV3 {
	return &NullablePaymentEventResponseV3{value: val, isSet: true}
}

func (v NullablePaymentEventResponseV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentEventResponseV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
