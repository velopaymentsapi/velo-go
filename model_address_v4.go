...
// checks if the AddressV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddressV4{}

// AddressV4 struct for AddressV4
...
func (o *AddressV4) SetCountyOrProvinceNil() {
...
func (o *AddressV4) SetZipOrPostcodeNil() {
...
func (o AddressV4) MarshalJSON() ([]byte, error) {
...
func (o AddressV4) ToMap() (map[string]interface{}, error) {
...
type NullableAddressV4 struct {
	value *AddressV4
	isSet bool
}

func (v NullableAddressV4) Get() *AddressV4 {
	return v.value
}

func (v *NullableAddressV4) Set(val *AddressV4) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressV4) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressV4(val *AddressV4) *NullableAddressV4 {
	return &NullableAddressV4{value: val, isSet: true}
}

func (v NullableAddressV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
