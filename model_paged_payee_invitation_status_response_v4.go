...
// checks if the PagedPayeeInvitationStatusResponseV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagedPayeeInvitationStatusResponseV4{}
...
func NewPagedPayeeInvitationStatusResponseV4() *PagedPayeeInvitationStatusResponseV4 {
	this := PagedPayeeInvitationStatusResponseV4{}
	return &this
}
...
func (o *PagedPayeeInvitationStatusResponseV4) GetContent() []PayeeInvitationStatusResponseV4 {
	if o == nil || IsNil(o.Content) {
		var ret []PayeeInvitationStatusResponseV4
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []PayeeInvitationStatusResponseV4 and assigns it to the Content field.
func (o *PagedPayeeInvitationStatusResponseV4) SetContent(v []PayeeInvitationStatusResponseV4) {
	o.Content = v
}

func (o PagedPayeeInvitationStatusResponseV4) MarshalJSON() ([]byte, error) {
...
func (o PagedPayeeInvitationStatusResponseV4) ToMap() (map[string]interface{}, error) {
...
type NullablePagedPayeeInvitationStatusResponseV4 struct {
	value *PagedPayeeInvitationStatusResponseV4
	isSet bool
}

func (v NullablePagedPayeeInvitationStatusResponseV4) Get() *PagedPayeeInvitationStatusResponseV4 {
	return v.value
}

func (v *NullablePagedPayeeInvitationStatusResponseV4) Set(val *PagedPayeeInvitationStatusResponseV4) {
	v.value = val
	v.isSet = true
}

func (v NullablePagedPayeeInvitationStatusResponseV4) IsSet() bool {
	return v.isSet
}

func (v *NullablePagedPayeeInvitationStatusResponseV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagedPayeeInvitationStatusResponseV4(val *PagedPayeeInvitationStatusResponseV4) *NullablePagedPayeeInvitationStatusResponseV4 {
	return &NullablePagedPayeeInvitationStatusResponseV4{value: val, isSet: true}
}

func (v NullablePagedPayeeInvitationStatusResponseV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagedPayeeInvitationStatusResponseV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
