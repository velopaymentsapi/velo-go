...
// checks if the FundingPayorStatusAuditResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FundingPayorStatusAuditResponse{}
...
func NewFundingPayorStatusAuditResponse() *FundingPayorStatusAuditResponse {
	this := FundingPayorStatusAuditResponse{}
	return &this
}
...
func (o FundingPayorStatusAuditResponse) MarshalJSON() ([]byte, error) {
...
func (o FundingPayorStatusAuditResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFundingPayorStatusAuditResponse struct {
	value *FundingPayorStatusAuditResponse
	isSet bool
}

func (v NullableFundingPayorStatusAuditResponse) Get() *FundingPayorStatusAuditResponse {
	return v.value
}

func (v *NullableFundingPayorStatusAuditResponse) Set(val *FundingPayorStatusAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFundingPayorStatusAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFundingPayorStatusAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFundingPayorStatusAuditResponse(val *FundingPayorStatusAuditResponse) *NullableFundingPayorStatusAuditResponse {
	return &NullableFundingPayorStatusAuditResponse{value: val, isSet: true}
}

func (v NullableFundingPayorStatusAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFundingPayorStatusAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
