...
// checks if the NameV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NameV3{}

// NameV3 struct for NameV3
type NameV3 struct {
...
func (o NameV3) MarshalJSON() ([]byte, error) {
...
func (o NameV3) ToMap() (map[string]interface{}, error) {
...
type NullableNameV3 struct {
	value *NameV3
	isSet bool
}

func (v NullableNameV3) Get() *NameV3 {
	return v.value
}

func (v *NullableNameV3) Set(val *NameV3) {
	v.value = val
	v.isSet = true
}

func (v NullableNameV3) IsSet() bool {
	return v.isSet
}

func (v *NullableNameV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNameV3(val *NameV3) *NullableNameV3 {
	return &NullableNameV3{value: val, isSet: true}
}

func (v NullableNameV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNameV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
