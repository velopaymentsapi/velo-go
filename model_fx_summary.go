...
// checks if the FxSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FxSummary{}

// FxSummary struct for FxSummary
...
// GetInvertedRate returns the InvertedRate field value
...
// GetInvertedRateOk returns a tuple with the InvertedRate field value
// and a boolean to check if the value has been set.
...
// SetInvertedRate sets field value
...
func (o *FxSummary) GetSourceCurrency() string {
...
// and a boolean to check if the value has been set.
func (o *FxSummary) GetSourceCurrencyOk() (*string, bool) {
	if o == nil || IsNil(o.SourceCurrency) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *FxSummary) GetPaymentCurrencyOk() (*string, bool) {
	if o == nil || IsNil(o.PaymentCurrency) {
		return nil, false
	}
...
func (o *FxSummary) SetPaymentCurrency(v string) {
	o.PaymentCurrency = &v
}
...
func (o FxSummary) MarshalJSON() ([]byte, error) {
...
func (o FxSummary) ToMap() (map[string]interface{}, error) {
...
type NullableFxSummary struct {
	value *FxSummary
	isSet bool
}

func (v NullableFxSummary) Get() *FxSummary {
	return v.value
}

func (v *NullableFxSummary) Set(val *FxSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableFxSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableFxSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFxSummary(val *FxSummary) *NullableFxSummary {
	return &NullableFxSummary{value: val, isSet: true}
}

func (v NullableFxSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFxSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
