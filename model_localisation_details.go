...
// checks if the LocalisationDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocalisationDetails{}

// LocalisationDetails struct for LocalisationDetails
...
func (o LocalisationDetails) MarshalJSON() ([]byte, error) {
...
func (o LocalisationDetails) ToMap() (map[string]interface{}, error) {
...
type NullableLocalisationDetails struct {
	value *LocalisationDetails
	isSet bool
}

func (v NullableLocalisationDetails) Get() *LocalisationDetails {
	return v.value
}

func (v *NullableLocalisationDetails) Set(val *LocalisationDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableLocalisationDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableLocalisationDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocalisationDetails(val *LocalisationDetails) *NullableLocalisationDetails {
	return &NullableLocalisationDetails{value: val, isSet: true}
}

func (v NullableLocalisationDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocalisationDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
