...
func (o *CompanyV1) SetOperatingNameNil() {
...
func (o CompanyV1) MarshalJSON() ([]byte, error) {
...
type NullableCompanyV1 struct {
	value *CompanyV1
	isSet bool
}

func (v NullableCompanyV1) Get() *CompanyV1 {
	return v.value
}

func (v *NullableCompanyV1) Set(val *CompanyV1) {
	v.value = val
	v.isSet = true
}

func (v NullableCompanyV1) IsSet() bool {
	return v.isSet
}

func (v *NullableCompanyV1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompanyV1(val *CompanyV1) *NullableCompanyV1 {
	return &NullableCompanyV1{value: val, isSet: true}
}

func (v NullableCompanyV1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompanyV1) UnmarshalJSON(src []byte) error {
	v.isSet = true
