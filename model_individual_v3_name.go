...
// checks if the IndividualV3Name type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IndividualV3Name{}

// IndividualV3Name struct for IndividualV3Name
...
func (o IndividualV3Name) MarshalJSON() ([]byte, error) {
...
func (o IndividualV3Name) ToMap() (map[string]interface{}, error) {
...
type NullableIndividualV3Name struct {
	value *IndividualV3Name
	isSet bool
}

func (v NullableIndividualV3Name) Get() *IndividualV3Name {
	return v.value
}

func (v *NullableIndividualV3Name) Set(val *IndividualV3Name) {
	v.value = val
	v.isSet = true
}

func (v NullableIndividualV3Name) IsSet() bool {
	return v.isSet
}

func (v *NullableIndividualV3Name) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIndividualV3Name(val *IndividualV3Name) *NullableIndividualV3Name {
	return &NullableIndividualV3Name{value: val, isSet: true}
}

func (v NullableIndividualV3Name) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIndividualV3Name) UnmarshalJSON(src []byte) error {
	v.isSet = true
