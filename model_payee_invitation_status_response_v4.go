...
// checks if the PayeeInvitationStatusResponseV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayeeInvitationStatusResponseV4{}

// PayeeInvitationStatusResponseV4 struct for PayeeInvitationStatusResponseV4
...
func NewPayeeInvitationStatusResponseV4(payeeId string, invitationStatus string) *PayeeInvitationStatusResponseV4 {
	this := PayeeInvitationStatusResponseV4{}
...
func (o PayeeInvitationStatusResponseV4) MarshalJSON() ([]byte, error) {
...
func (o PayeeInvitationStatusResponseV4) ToMap() (map[string]interface{}, error) {
...
type NullablePayeeInvitationStatusResponseV4 struct {
	value *PayeeInvitationStatusResponseV4
	isSet bool
}

func (v NullablePayeeInvitationStatusResponseV4) Get() *PayeeInvitationStatusResponseV4 {
	return v.value
}

func (v *NullablePayeeInvitationStatusResponseV4) Set(val *PayeeInvitationStatusResponseV4) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeInvitationStatusResponseV4) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeInvitationStatusResponseV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeInvitationStatusResponseV4(val *PayeeInvitationStatusResponseV4) *NullablePayeeInvitationStatusResponseV4 {
	return &NullablePayeeInvitationStatusResponseV4{value: val, isSet: true}
}

func (v NullablePayeeInvitationStatusResponseV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeInvitationStatusResponseV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
