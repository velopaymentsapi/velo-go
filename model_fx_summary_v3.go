...
// checks if the FxSummaryV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FxSummaryV3{}
...
func (o FxSummaryV3) MarshalJSON() ([]byte, error) {
...
func (o FxSummaryV3) ToMap() (map[string]interface{}, error) {
...
type NullableFxSummaryV3 struct {
	value *FxSummaryV3
	isSet bool
}

func (v NullableFxSummaryV3) Get() *FxSummaryV3 {
	return v.value
}

func (v *NullableFxSummaryV3) Set(val *FxSummaryV3) {
	v.value = val
	v.isSet = true
}

func (v NullableFxSummaryV3) IsSet() bool {
	return v.isSet
}

func (v *NullableFxSummaryV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFxSummaryV3(val *FxSummaryV3) *NullableFxSummaryV3 {
	return &NullableFxSummaryV3{value: val, isSet: true}
}

func (v NullableFxSummaryV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFxSummaryV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
