...
// checks if the GetPayoutsResponseV3Links type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPayoutsResponseV3Links{}
...
func NewGetPayoutsResponseV3Links() *GetPayoutsResponseV3Links {
	this := GetPayoutsResponseV3Links{}
	return &this
}
...
func (o GetPayoutsResponseV3Links) MarshalJSON() ([]byte, error) {
...
func (o GetPayoutsResponseV3Links) ToMap() (map[string]interface{}, error) {
...
type NullableGetPayoutsResponseV3Links struct {
	value *GetPayoutsResponseV3Links
	isSet bool
}

func (v NullableGetPayoutsResponseV3Links) Get() *GetPayoutsResponseV3Links {
	return v.value
}

func (v *NullableGetPayoutsResponseV3Links) Set(val *GetPayoutsResponseV3Links) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPayoutsResponseV3Links) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPayoutsResponseV3Links) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPayoutsResponseV3Links(val *GetPayoutsResponseV3Links) *NullableGetPayoutsResponseV3Links {
	return &NullableGetPayoutsResponseV3Links{value: val, isSet: true}
}

func (v NullableGetPayoutsResponseV3Links) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPayoutsResponseV3Links) UnmarshalJSON(src []byte) error {
	v.isSet = true
