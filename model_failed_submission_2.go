...
// SetFailedSubmission gets a reference to the given FailedPayee2 and assigns it to the FailedSubmission field.
...
func (o FailedSubmission2) MarshalJSON() ([]byte, error) {
...
type NullableFailedSubmission2 struct {
	value *FailedSubmission2
	isSet bool
}

func (v NullableFailedSubmission2) Get() *FailedSubmission2 {
	return v.value
}

func (v *NullableFailedSubmission2) Set(val *FailedSubmission2) {
	v.value = val
	v.isSet = true
}

func (v NullableFailedSubmission2) IsSet() bool {
	return v.isSet
}

func (v *NullableFailedSubmission2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFailedSubmission2(val *FailedSubmission2) *NullableFailedSubmission2 {
	return &NullableFailedSubmission2{value: val, isSet: true}
}

func (v NullableFailedSubmission2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFailedSubmission2) UnmarshalJSON(src []byte) error {
	v.isSet = true
