...
// checks if the SupportedCountry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportedCountry{}
...
func (o SupportedCountry) MarshalJSON() ([]byte, error) {
...
func (o SupportedCountry) ToMap() (map[string]interface{}, error) {
...
type NullableSupportedCountry struct {
	value *SupportedCountry
	isSet bool
}

func (v NullableSupportedCountry) Get() *SupportedCountry {
	return v.value
}

func (v *NullableSupportedCountry) Set(val *SupportedCountry) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportedCountry) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportedCountry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportedCountry(val *SupportedCountry) *NullableSupportedCountry {
	return &NullableSupportedCountry{value: val, isSet: true}
}

func (v NullableSupportedCountry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportedCountry) UnmarshalJSON(src []byte) error {
	v.isSet = true
