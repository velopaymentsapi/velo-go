...
func (o *CreatePayee) SetCompanyNil() {
	o.Company.Set(nil)
}
...
func (o CreatePayee) MarshalJSON() ([]byte, error) {
...
type NullableCreatePayee struct {
	value *CreatePayee
	isSet bool
}

func (v NullableCreatePayee) Get() *CreatePayee {
	return v.value
}

func (v *NullableCreatePayee) Set(val *CreatePayee) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePayee) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePayee) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePayee(val *CreatePayee) *NullableCreatePayee {
	return &NullableCreatePayee{value: val, isSet: true}
}

func (v NullableCreatePayee) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePayee) UnmarshalJSON(src []byte) error {
	v.isSet = true
