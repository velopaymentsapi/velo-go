...
type ApiResendTokenRequest struct {
	ctx context.Context
...
func (r ApiResendTokenRequest) ResendTokenRequest(resendTokenRequest ResendTokenRequest) ApiResendTokenRequest {
	r.resendTokenRequest = &resendTokenRequest
	return r
}

func (r ApiResendTokenRequest) Execute() (*http.Response, error) {
...
<p>It will be revoked and a new one issued</p>
 ...
 @return ApiResendTokenRequest
*/
func (a *TokensAPIService) ResendToken(ctx context.Context, userId string) ApiResendTokenRequest {
	return ApiResendTokenRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *TokensAPIService) ResendTokenExecute(r ApiResendTokenRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TokensAPIService.ResendToken")
	if err != nil {
