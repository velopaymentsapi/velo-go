...
func (r ApiResendTokenRequest) Execute() (*_nethttp.Response, error) {
 ...
 */
func (a *TokensApiService) ResendToken(ctx _context.Context, userId string) ApiResendTokenRequest {
	return ApiResendTokenRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
 ...
 */
func (a *TokensApiService) ResendTokenExecute(r ApiResendTokenRequest) (*_nethttp.Response, error) {
	var (
