...
// checks if the FailedPayeeV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FailedPayeeV3{}

// FailedPayeeV3 struct for FailedPayeeV3
...
// SetAddress gets a reference to the given CreatePayeeAddressV3 and assigns it to the Address field.
...
func (o *FailedPayeeV3) SetCompanyNil() {
	o.Company.Set(nil)
}
...
func (o FailedPayeeV3) MarshalJSON() ([]byte, error) {
...
func (o FailedPayeeV3) ToMap() (map[string]interface{}, error) {
...
type NullableFailedPayeeV3 struct {
	value *FailedPayeeV3
	isSet bool
}

func (v NullableFailedPayeeV3) Get() *FailedPayeeV3 {
	return v.value
}

func (v *NullableFailedPayeeV3) Set(val *FailedPayeeV3) {
	v.value = val
	v.isSet = true
}

func (v NullableFailedPayeeV3) IsSet() bool {
	return v.isSet
}

func (v *NullableFailedPayeeV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFailedPayeeV3(val *FailedPayeeV3) *NullableFailedPayeeV3 {
	return &NullableFailedPayeeV3{value: val, isSet: true}
}

func (v NullableFailedPayeeV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFailedPayeeV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
