...
func (o PagedPayeeResponseLinks) MarshalJSON() ([]byte, error) {
...
type NullablePagedPayeeResponseLinks struct {
	value *PagedPayeeResponseLinks
	isSet bool
}

func (v NullablePagedPayeeResponseLinks) Get() *PagedPayeeResponseLinks {
	return v.value
}

func (v *NullablePagedPayeeResponseLinks) Set(val *PagedPayeeResponseLinks) {
	v.value = val
	v.isSet = true
}

func (v NullablePagedPayeeResponseLinks) IsSet() bool {
	return v.isSet
}

func (v *NullablePagedPayeeResponseLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagedPayeeResponseLinks(val *PagedPayeeResponseLinks) *NullablePagedPayeeResponseLinks {
	return &NullablePagedPayeeResponseLinks{value: val, isSet: true}
}

func (v NullablePagedPayeeResponseLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagedPayeeResponseLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
