...
func NewListSourceAccountResponseLinks() *ListSourceAccountResponseLinks {
	this := ListSourceAccountResponseLinks{}
	return &this
}
...
func (o ListSourceAccountResponseLinks) MarshalJSON() ([]byte, error) {
...
type NullableListSourceAccountResponseLinks struct {
	value *ListSourceAccountResponseLinks
	isSet bool
}

func (v NullableListSourceAccountResponseLinks) Get() *ListSourceAccountResponseLinks {
	return v.value
}

func (v *NullableListSourceAccountResponseLinks) Set(val *ListSourceAccountResponseLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableListSourceAccountResponseLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableListSourceAccountResponseLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSourceAccountResponseLinks(val *ListSourceAccountResponseLinks) *NullableListSourceAccountResponseLinks {
	return &NullableListSourceAccountResponseLinks{value: val, isSet: true}
}

func (v NullableListSourceAccountResponseLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSourceAccountResponseLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
