...
func NewPagedPayeeInvitationStatusResponse() *PagedPayeeInvitationStatusResponse {
	this := PagedPayeeInvitationStatusResponse{}
	return &this
}
...
func (o *PagedPayeeInvitationStatusResponse) GetContent() []PayeeInvitationStatusResponse {
	if o == nil || o.Content == nil {
		var ret []PayeeInvitationStatusResponse
		return ret
	}
	return *o.Content
}
...
// SetContent gets a reference to the given []PayeeInvitationStatusResponse and assigns it to the Content field.
func (o *PagedPayeeInvitationStatusResponse) SetContent(v []PayeeInvitationStatusResponse) {
	o.Content = &v
}

func (o PagedPayeeInvitationStatusResponse) MarshalJSON() ([]byte, error) {
...
type NullablePagedPayeeInvitationStatusResponse struct {
	value *PagedPayeeInvitationStatusResponse
	isSet bool
}

func (v NullablePagedPayeeInvitationStatusResponse) Get() *PagedPayeeInvitationStatusResponse {
	return v.value
}

func (v *NullablePagedPayeeInvitationStatusResponse) Set(val *PagedPayeeInvitationStatusResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePagedPayeeInvitationStatusResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePagedPayeeInvitationStatusResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagedPayeeInvitationStatusResponse(val *PagedPayeeInvitationStatusResponse) *NullablePagedPayeeInvitationStatusResponse {
	return &NullablePagedPayeeInvitationStatusResponse{value: val, isSet: true}
}

func (v NullablePagedPayeeInvitationStatusResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagedPayeeInvitationStatusResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
