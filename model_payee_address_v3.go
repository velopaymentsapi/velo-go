...
// checks if the PayeeAddressV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayeeAddressV3{}

// PayeeAddressV3 struct for PayeeAddressV3
...
func (o *PayeeAddressV3) SetLine2Nil() {
	o.Line2.Set(nil)
}
...
func (o *PayeeAddressV3) SetLine3Nil() {
	o.Line3.Set(nil)
}
...
func (o *PayeeAddressV3) SetLine4Nil() {
	o.Line4.Set(nil)
}
...
func (o *PayeeAddressV3) SetCountyOrProvinceNil() {
...
func (o *PayeeAddressV3) SetZipOrPostcodeNil() {
...
func (o PayeeAddressV3) MarshalJSON() ([]byte, error) {
...
func (o PayeeAddressV3) ToMap() (map[string]interface{}, error) {
...
type NullablePayeeAddressV3 struct {
	value *PayeeAddressV3
	isSet bool
}

func (v NullablePayeeAddressV3) Get() *PayeeAddressV3 {
	return v.value
}

func (v *NullablePayeeAddressV3) Set(val *PayeeAddressV3) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeAddressV3) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeAddressV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeAddressV3(val *PayeeAddressV3) *NullablePayeeAddressV3 {
	return &NullablePayeeAddressV3{value: val, isSet: true}
}

func (v NullablePayeeAddressV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeAddressV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
