...
// checks if the GetPayeeListResponseV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPayeeListResponseV3{}

// GetPayeeListResponseV3 struct for GetPayeeListResponseV3
...
func (o *GetPayeeListResponseV3) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o *GetPayeeListResponseV3) SetWatchlistStatusUpdatedTimestampNil() {
...
func (o *GetPayeeListResponseV3) SetWatchlistOverrideCommentNil() {
...
func (o *GetPayeeListResponseV3) GetIndividual() GetPayeeListResponseIndividualV3 {
	if o == nil || IsNil(o.Individual) {
		var ret GetPayeeListResponseIndividualV3
		return ret
	}
	return *o.Individual
}
...
// SetIndividual gets a reference to the given GetPayeeListResponseIndividualV3 and assigns it to the Individual field.
...
func (o *GetPayeeListResponseV3) GetCompany() GetPayeeListResponseCompanyV3 {
	if o == nil || IsNil(o.Company) {
		var ret GetPayeeListResponseCompanyV3
		return ret
	}
	return *o.Company
}
...
// SetCompany gets a reference to the given GetPayeeListResponseCompanyV3 and assigns it to the Company field.
func (o *GetPayeeListResponseV3) SetCompany(v GetPayeeListResponseCompanyV3) {
	o.Company = &v
}

func (o GetPayeeListResponseV3) MarshalJSON() ([]byte, error) {
...
func (o GetPayeeListResponseV3) ToMap() (map[string]interface{}, error) {
...
type NullableGetPayeeListResponseV3 struct {
	value *GetPayeeListResponseV3
	isSet bool
}

func (v NullableGetPayeeListResponseV3) Get() *GetPayeeListResponseV3 {
	return v.value
}

func (v *NullableGetPayeeListResponseV3) Set(val *GetPayeeListResponseV3) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPayeeListResponseV3) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPayeeListResponseV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPayeeListResponseV3(val *GetPayeeListResponseV3) *NullableGetPayeeListResponseV3 {
	return &NullableGetPayeeListResponseV3{value: val, isSet: true}
}

func (v NullableGetPayeeListResponseV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPayeeListResponseV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
