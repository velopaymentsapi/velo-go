...
// SetPayoutFrom gets a reference to the given PayoutPayorV4 and assigns it to the PayoutFrom field.
...
// SetPayoutTo gets a reference to the given PayoutPayorV4 and assigns it to the PayoutTo field.
