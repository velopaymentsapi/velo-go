...
// checks if the PaymentResponseV4Payout type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentResponseV4Payout{}
...
func (o PaymentResponseV4Payout) ToMap() (map[string]interface{}, error) {
