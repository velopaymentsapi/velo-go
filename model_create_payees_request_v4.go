...
// checks if the CreatePayeesRequestV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePayeesRequestV4{}

// CreatePayeesRequestV4 struct for CreatePayeesRequestV4
...
func (o CreatePayeesRequestV4) MarshalJSON() ([]byte, error) {
...
func (o CreatePayeesRequestV4) ToMap() (map[string]interface{}, error) {
...
type NullableCreatePayeesRequestV4 struct {
	value *CreatePayeesRequestV4
	isSet bool
}

func (v NullableCreatePayeesRequestV4) Get() *CreatePayeesRequestV4 {
	return v.value
}

func (v *NullableCreatePayeesRequestV4) Set(val *CreatePayeesRequestV4) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePayeesRequestV4) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePayeesRequestV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePayeesRequestV4(val *CreatePayeesRequestV4) *NullableCreatePayeesRequestV4 {
	return &NullableCreatePayeesRequestV4{value: val, isSet: true}
}

func (v NullableCreatePayeesRequestV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePayeesRequestV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
