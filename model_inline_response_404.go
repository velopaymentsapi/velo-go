...
type InlineResponse404 struct {
	// one or more errors
	Errors []InlineResponse404Errors `json:"errors,omitempty"`
...
func (o *InlineResponse404) GetErrors() []InlineResponse404Errors {
	if o == nil  {
		var ret []InlineResponse404Errors
		return ret
	}
	return o.Errors
}
...
// SetErrors gets a reference to the given []InlineResponse404Errors and assigns it to the Errors field.
