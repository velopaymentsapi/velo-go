...
// checks if the PayeeInvitationStatusResponseV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayeeInvitationStatusResponseV3{}

// PayeeInvitationStatusResponseV3 struct for PayeeInvitationStatusResponseV3
...
func NewPayeeInvitationStatusResponseV3(payeeId string, invitationStatus string) *PayeeInvitationStatusResponseV3 {
	this := PayeeInvitationStatusResponseV3{}
...
// SetGracePeriodEndDate gets a reference to the given string and assigns it to the GracePeriodEndDate field.
func (o *PayeeInvitationStatusResponseV3) SetGracePeriodEndDate(v string) {
	o.GracePeriodEndDate = &v
}

func (o PayeeInvitationStatusResponseV3) MarshalJSON() ([]byte, error) {
...
func (o PayeeInvitationStatusResponseV3) ToMap() (map[string]interface{}, error) {
...
type NullablePayeeInvitationStatusResponseV3 struct {
	value *PayeeInvitationStatusResponseV3
	isSet bool
}

func (v NullablePayeeInvitationStatusResponseV3) Get() *PayeeInvitationStatusResponseV3 {
	return v.value
}

func (v *NullablePayeeInvitationStatusResponseV3) Set(val *PayeeInvitationStatusResponseV3) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeInvitationStatusResponseV3) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeInvitationStatusResponseV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeInvitationStatusResponseV3(val *PayeeInvitationStatusResponseV3) *NullablePayeeInvitationStatusResponseV3 {
	return &NullablePayeeInvitationStatusResponseV3{value: val, isSet: true}
}

func (v NullablePayeeInvitationStatusResponseV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeInvitationStatusResponseV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
