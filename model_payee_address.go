...
func (o *PayeeAddress) SetLine2Nil() {
	o.Line2.Set(nil)
}
...
func (o *PayeeAddress) SetLine3Nil() {
	o.Line3.Set(nil)
}
...
func (o *PayeeAddress) SetLine4Nil() {
	o.Line4.Set(nil)
}
...
func (o *PayeeAddress) SetCountyOrProvinceNil() {
...
func (o *PayeeAddress) SetZipOrPostcodeNil() {
...
func (o PayeeAddress) MarshalJSON() ([]byte, error) {
...
type NullablePayeeAddress struct {
	value *PayeeAddress
	isSet bool
}

func (v NullablePayeeAddress) Get() *PayeeAddress {
	return v.value
}

func (v *NullablePayeeAddress) Set(val *PayeeAddress) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeAddress) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeAddress(val *PayeeAddress) *NullablePayeeAddress {
	return &NullablePayeeAddress{value: val, isSet: true}
}

func (v NullablePayeeAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
