...
// checks if the PagedPayeeResponseV3Page type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagedPayeeResponseV3Page{}

// PagedPayeeResponseV3Page struct for PagedPayeeResponseV3Page
...
func (o PagedPayeeResponseV3Page) MarshalJSON() ([]byte, error) {
...
func (o PagedPayeeResponseV3Page) ToMap() (map[string]interface{}, error) {
...
type NullablePagedPayeeResponseV3Page struct {
	value *PagedPayeeResponseV3Page
	isSet bool
}

func (v NullablePagedPayeeResponseV3Page) Get() *PagedPayeeResponseV3Page {
	return v.value
}

func (v *NullablePagedPayeeResponseV3Page) Set(val *PagedPayeeResponseV3Page) {
	v.value = val
	v.isSet = true
}

func (v NullablePagedPayeeResponseV3Page) IsSet() bool {
	return v.isSet
}

func (v *NullablePagedPayeeResponseV3Page) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagedPayeeResponseV3Page(val *PagedPayeeResponseV3Page) *NullablePagedPayeeResponseV3Page {
	return &NullablePagedPayeeResponseV3Page{value: val, isSet: true}
}

func (v NullablePagedPayeeResponseV3Page) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagedPayeeResponseV3Page) UnmarshalJSON(src []byte) error {
	v.isSet = true
