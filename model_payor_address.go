...
// checks if the PayorAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayorAddress{}
...
func (o *PayorAddress) SetLine2Nil() {
	o.Line2.Set(nil)
}
...
func (o *PayorAddress) SetLine3Nil() {
	o.Line3.Set(nil)
}
...
func (o *PayorAddress) SetLine4Nil() {
	o.Line4.Set(nil)
}
...
func (o *PayorAddress) SetCountyOrProvinceNil() {
...
func (o *PayorAddress) SetZipOrPostcodeNil() {
...
func (o PayorAddress) MarshalJSON() ([]byte, error) {
...
func (o PayorAddress) ToMap() (map[string]interface{}, error) {
...
type NullablePayorAddress struct {
	value *PayorAddress
	isSet bool
}

func (v NullablePayorAddress) Get() *PayorAddress {
	return v.value
}

func (v *NullablePayorAddress) Set(val *PayorAddress) {
	v.value = val
	v.isSet = true
}

func (v NullablePayorAddress) IsSet() bool {
	return v.isSet
}

func (v *NullablePayorAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayorAddress(val *PayorAddress) *NullablePayorAddress {
	return &NullablePayorAddress{value: val, isSet: true}
}

func (v NullablePayorAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayorAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
