...
// checks if the PagedUserResponseLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagedUserResponseLinks{}
...
func (o PagedUserResponseLinks) MarshalJSON() ([]byte, error) {
...
func (o PagedUserResponseLinks) ToMap() (map[string]interface{}, error) {
...
type NullablePagedUserResponseLinks struct {
	value *PagedUserResponseLinks
	isSet bool
}

func (v NullablePagedUserResponseLinks) Get() *PagedUserResponseLinks {
	return v.value
}

func (v *NullablePagedUserResponseLinks) Set(val *PagedUserResponseLinks) {
	v.value = val
	v.isSet = true
}

func (v NullablePagedUserResponseLinks) IsSet() bool {
	return v.isSet
}

func (v *NullablePagedUserResponseLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagedUserResponseLinks(val *PagedUserResponseLinks) *NullablePagedUserResponseLinks {
	return &NullablePagedUserResponseLinks{value: val, isSet: true}
}

func (v NullablePagedUserResponseLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagedUserResponseLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
