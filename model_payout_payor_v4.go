...
func (o PayoutPayorV4) MarshalJSON() ([]byte, error) {
...
type NullablePayoutPayorV4 struct {
	value *PayoutPayorV4
	isSet bool
}

func (v NullablePayoutPayorV4) Get() *PayoutPayorV4 {
	return v.value
}

func (v *NullablePayoutPayorV4) Set(val *PayoutPayorV4) {
	v.value = val
	v.isSet = true
}

func (v NullablePayoutPayorV4) IsSet() bool {
	return v.isSet
}

func (v *NullablePayoutPayorV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayoutPayorV4(val *PayoutPayorV4) *NullablePayoutPayorV4 {
	return &NullablePayoutPayorV4{value: val, isSet: true}
}

func (v NullablePayoutPayorV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayoutPayorV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
