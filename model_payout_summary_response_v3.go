...
type PayoutSummaryResponseV3 struct {
	...
	Schedule *PayoutSchedule2 `json:"schedule,omitempty"`
}
...
// SetSchedule gets a reference to the given PayoutSchedule2 and assigns it to the Schedule field.
