...
// checks if the PagedPayeeResponseV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagedPayeeResponseV3{}
...
func (o *PagedPayeeResponseV3) GetContent() []GetPayeeListResponseV3 {
	if o == nil || IsNil(o.Content) {
		var ret []GetPayeeListResponseV3
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []GetPayeeListResponseV3 and assigns it to the Content field.
func (o *PagedPayeeResponseV3) SetContent(v []GetPayeeListResponseV3) {
	o.Content = v
}

func (o PagedPayeeResponseV3) MarshalJSON() ([]byte, error) {
...
func (o PagedPayeeResponseV3) ToMap() (map[string]interface{}, error) {
...
type NullablePagedPayeeResponseV3 struct {
	value *PagedPayeeResponseV3
	isSet bool
}

func (v NullablePagedPayeeResponseV3) Get() *PagedPayeeResponseV3 {
	return v.value
}

func (v *NullablePagedPayeeResponseV3) Set(val *PagedPayeeResponseV3) {
	v.value = val
	v.isSet = true
}

func (v NullablePagedPayeeResponseV3) IsSet() bool {
	return v.isSet
}

func (v *NullablePagedPayeeResponseV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagedPayeeResponseV3(val *PagedPayeeResponseV3) *NullablePagedPayeeResponseV3 {
	return &NullablePagedPayeeResponseV3{value: val, isSet: true}
}

func (v NullablePagedPayeeResponseV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagedPayeeResponseV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
