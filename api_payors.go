...
func (a *PayorsApiService) PayorCreateApiKeyRequest(ctx _context.Context, payorId string, applicationId string, payorCreateApiKeyRequest PayorCreateApiKeyRequest) (PayorCreateApiKeyResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/payors/{payorId}/applications/{applicationId}/keys"
	localVarPath = strings.Replace(localVarPath, "{"+"payorId"+"}", _neturl.PathEscape(parameterToString(payorId, "")) , -1)

	localVarPath = strings.Replace(localVarPath, "{"+"applicationId"+"}", _neturl.PathEscape(parameterToString(applicationId, "")) , -1)
	...
	// body params
	localVarPostBody = &payorCreateApiKeyRequest
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (a *PayorsApiService) PayorCreateApplicationRequest(ctx _context.Context, payorId string, payorCreateApplicationRequest PayorCreateApplicationRequest) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/payors/{payorId}/applications"
	localVarPath = strings.Replace(localVarPath, "{"+"payorId"+"}", _neturl.PathEscape(parameterToString(payorId, "")) , -1)
	...
	// body params
	localVarPostBody = &payorCreateApplicationRequest
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
