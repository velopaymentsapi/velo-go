...
// SchedulePayoutRequest struct for SchedulePayoutRequest
...
func (o SchedulePayoutRequest) MarshalJSON() ([]byte, error) {
...
type NullableSchedulePayoutRequest struct {
	value *SchedulePayoutRequest
	isSet bool
}

func (v NullableSchedulePayoutRequest) Get() *SchedulePayoutRequest {
	return v.value
}

func (v *NullableSchedulePayoutRequest) Set(val *SchedulePayoutRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSchedulePayoutRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSchedulePayoutRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSchedulePayoutRequest(val *SchedulePayoutRequest) *NullableSchedulePayoutRequest {
	return &NullableSchedulePayoutRequest{value: val, isSet: true}
}

func (v NullableSchedulePayoutRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSchedulePayoutRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
