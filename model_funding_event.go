...
func (o *FundingEvent) GetFundingEventType() FundingEventType {
	if o == nil || o.FundingEventType == nil {
		var ret FundingEventType
		return ret
	}
...
// SetFundingEventType gets a reference to the given FundingEventType and assigns it to the FundingEventType field.
