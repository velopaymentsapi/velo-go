...
// checks if the GetPaymentsForPayoutResponseV3Page type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPaymentsForPayoutResponseV3Page{}
...
func NewGetPaymentsForPayoutResponseV3Page() *GetPaymentsForPayoutResponseV3Page {
	this := GetPaymentsForPayoutResponseV3Page{}
	return &this
}
...
func (o GetPaymentsForPayoutResponseV3Page) MarshalJSON() ([]byte, error) {
...
func (o GetPaymentsForPayoutResponseV3Page) ToMap() (map[string]interface{}, error) {
...
type NullableGetPaymentsForPayoutResponseV3Page struct {
	value *GetPaymentsForPayoutResponseV3Page
	isSet bool
}

func (v NullableGetPaymentsForPayoutResponseV3Page) Get() *GetPaymentsForPayoutResponseV3Page {
	return v.value
}

func (v *NullableGetPaymentsForPayoutResponseV3Page) Set(val *GetPaymentsForPayoutResponseV3Page) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPaymentsForPayoutResponseV3Page) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPaymentsForPayoutResponseV3Page) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPaymentsForPayoutResponseV3Page(val *GetPaymentsForPayoutResponseV3Page) *NullableGetPaymentsForPayoutResponseV3Page {
	return &NullableGetPaymentsForPayoutResponseV3Page{value: val, isSet: true}
}

func (v NullableGetPaymentsForPayoutResponseV3Page) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPaymentsForPayoutResponseV3Page) UnmarshalJSON(src []byte) error {
	v.isSet = true
