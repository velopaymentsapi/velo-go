...
// checks if the PayeeDeltaResponseV3Page type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayeeDeltaResponseV3Page{}

// PayeeDeltaResponseV3Page struct for PayeeDeltaResponseV3Page
...
func (o PayeeDeltaResponseV3Page) MarshalJSON() ([]byte, error) {
...
func (o PayeeDeltaResponseV3Page) ToMap() (map[string]interface{}, error) {
...
type NullablePayeeDeltaResponseV3Page struct {
	value *PayeeDeltaResponseV3Page
	isSet bool
}

func (v NullablePayeeDeltaResponseV3Page) Get() *PayeeDeltaResponseV3Page {
	return v.value
}

func (v *NullablePayeeDeltaResponseV3Page) Set(val *PayeeDeltaResponseV3Page) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeDeltaResponseV3Page) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeDeltaResponseV3Page) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeDeltaResponseV3Page(val *PayeeDeltaResponseV3Page) *NullablePayeeDeltaResponseV3Page {
	return &NullablePayeeDeltaResponseV3Page{value: val, isSet: true}
}

func (v NullablePayeeDeltaResponseV3Page) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeDeltaResponseV3Page) UnmarshalJSON(src []byte) error {
	v.isSet = true
