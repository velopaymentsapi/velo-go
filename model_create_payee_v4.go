...
// checks if the CreatePayeeV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePayeeV4{}

// CreatePayeeV4 struct for CreatePayeeV4
...
func (o *CreatePayeeV4) SetCompanyNil() {
	o.Company.Set(nil)
}
...
func (o CreatePayeeV4) MarshalJSON() ([]byte, error) {
...
func (o CreatePayeeV4) ToMap() (map[string]interface{}, error) {
...
type NullableCreatePayeeV4 struct {
	value *CreatePayeeV4
	isSet bool
}

func (v NullableCreatePayeeV4) Get() *CreatePayeeV4 {
	return v.value
}

func (v *NullableCreatePayeeV4) Set(val *CreatePayeeV4) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePayeeV4) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePayeeV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePayeeV4(val *CreatePayeeV4) *NullableCreatePayeeV4 {
	return &NullableCreatePayeeV4{value: val, isSet: true}
}

func (v NullableCreatePayeeV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePayeeV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
