...
func (o PagedPayeeResponsePage) MarshalJSON() ([]byte, error) {
...
type NullablePagedPayeeResponsePage struct {
	value *PagedPayeeResponsePage
	isSet bool
}

func (v NullablePagedPayeeResponsePage) Get() *PagedPayeeResponsePage {
	return v.value
}

func (v *NullablePagedPayeeResponsePage) Set(val *PagedPayeeResponsePage) {
	v.value = val
	v.isSet = true
}

func (v NullablePagedPayeeResponsePage) IsSet() bool {
	return v.isSet
}

func (v *NullablePagedPayeeResponsePage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagedPayeeResponsePage(val *PagedPayeeResponsePage) *NullablePagedPayeeResponsePage {
	return &NullablePagedPayeeResponsePage{value: val, isSet: true}
}

func (v NullablePagedPayeeResponsePage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagedPayeeResponsePage) UnmarshalJSON(src []byte) error {
	v.isSet = true
