...
func (o PayeeDeltaResponse2Links) MarshalJSON() ([]byte, error) {
...
type NullablePayeeDeltaResponse2Links struct {
	value *PayeeDeltaResponse2Links
	isSet bool
}

func (v NullablePayeeDeltaResponse2Links) Get() *PayeeDeltaResponse2Links {
	return v.value
}

func (v *NullablePayeeDeltaResponse2Links) Set(val *PayeeDeltaResponse2Links) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeDeltaResponse2Links) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeDeltaResponse2Links) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeDeltaResponse2Links(val *PayeeDeltaResponse2Links) *NullablePayeeDeltaResponse2Links {
	return &NullablePayeeDeltaResponse2Links{value: val, isSet: true}
}

func (v NullablePayeeDeltaResponse2Links) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeDeltaResponse2Links) UnmarshalJSON(src []byte) error {
	v.isSet = true
