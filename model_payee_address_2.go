...
func (o *PayeeAddress2) SetLine2Nil() {
	o.Line2.Set(nil)
}
...
func (o *PayeeAddress2) SetLine3Nil() {
	o.Line3.Set(nil)
}
...
func (o *PayeeAddress2) SetLine4Nil() {
	o.Line4.Set(nil)
}
...
func (o *PayeeAddress2) SetCountyOrProvinceNil() {
...
func (o *PayeeAddress2) SetZipOrPostcodeNil() {
...
func (o PayeeAddress2) MarshalJSON() ([]byte, error) {
...
type NullablePayeeAddress2 struct {
	value *PayeeAddress2
	isSet bool
}

func (v NullablePayeeAddress2) Get() *PayeeAddress2 {
	return v.value
}

func (v *NullablePayeeAddress2) Set(val *PayeeAddress2) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeAddress2) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeAddress2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeAddress2(val *PayeeAddress2) *NullablePayeeAddress2 {
	return &NullablePayeeAddress2{value: val, isSet: true}
}

func (v NullablePayeeAddress2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeAddress2) UnmarshalJSON(src []byte) error {
	v.isSet = true
