...
// checks if the CreatePayoutRequestV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePayoutRequestV3{}
...
func (o *CreatePayoutRequestV3) GetPayoutFromPayorId() string {
	if o == nil || IsNil(o.PayoutFromPayorId) {
		var ret string
		return ret
	}
...
func (o *CreatePayoutRequestV3) GetPayoutToPayorId() string {
	if o == nil || IsNil(o.PayoutToPayorId) {
		var ret string
		return ret
	}
...
func (o CreatePayoutRequestV3) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.PayoutFromPayorId) {
		toSerialize["payoutFromPayorId"] = o.PayoutFromPayorId
	}
	if !IsNil(o.PayoutToPayorId) {
