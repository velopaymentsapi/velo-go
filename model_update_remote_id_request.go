...
func (o UpdateRemoteIdRequest) MarshalJSON() ([]byte, error) {
...
type NullableUpdateRemoteIdRequest struct {
	value *UpdateRemoteIdRequest
	isSet bool
}

func (v NullableUpdateRemoteIdRequest) Get() *UpdateRemoteIdRequest {
	return v.value
}

func (v *NullableUpdateRemoteIdRequest) Set(val *UpdateRemoteIdRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateRemoteIdRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateRemoteIdRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateRemoteIdRequest(val *UpdateRemoteIdRequest) *NullableUpdateRemoteIdRequest {
	return &NullableUpdateRemoteIdRequest{value: val, isSet: true}
}

func (v NullableUpdateRemoteIdRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateRemoteIdRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
