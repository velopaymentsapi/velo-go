...
func (o PayeeDeltaResponseLinks) MarshalJSON() ([]byte, error) {
...
type NullablePayeeDeltaResponseLinks struct {
	value *PayeeDeltaResponseLinks
	isSet bool
}

func (v NullablePayeeDeltaResponseLinks) Get() *PayeeDeltaResponseLinks {
	return v.value
}

func (v *NullablePayeeDeltaResponseLinks) Set(val *PayeeDeltaResponseLinks) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeDeltaResponseLinks) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeDeltaResponseLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeDeltaResponseLinks(val *PayeeDeltaResponseLinks) *NullablePayeeDeltaResponseLinks {
	return &NullablePayeeDeltaResponseLinks{value: val, isSet: true}
}

func (v NullablePayeeDeltaResponseLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeDeltaResponseLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
