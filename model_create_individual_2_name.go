...
func (o CreateIndividual2Name) MarshalJSON() ([]byte, error) {
...
type NullableCreateIndividual2Name struct {
	value *CreateIndividual2Name
	isSet bool
}

func (v NullableCreateIndividual2Name) Get() *CreateIndividual2Name {
	return v.value
}

func (v *NullableCreateIndividual2Name) Set(val *CreateIndividual2Name) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateIndividual2Name) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateIndividual2Name) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateIndividual2Name(val *CreateIndividual2Name) *NullableCreateIndividual2Name {
	return &NullableCreateIndividual2Name{value: val, isSet: true}
}

func (v NullableCreateIndividual2Name) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateIndividual2Name) UnmarshalJSON(src []byte) error {
	v.isSet = true
