...
// checks if the UpdatePaymentChannelRequestV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdatePaymentChannelRequestV4{}

// UpdatePaymentChannelRequestV4 struct for UpdatePaymentChannelRequestV4
type UpdatePaymentChannelRequestV4 struct {
...
func NewUpdatePaymentChannelRequestV4() *UpdatePaymentChannelRequestV4 {
	this := UpdatePaymentChannelRequestV4{}
	return &this
}
...
func (o UpdatePaymentChannelRequestV4) MarshalJSON() ([]byte, error) {
...
func (o UpdatePaymentChannelRequestV4) ToMap() (map[string]interface{}, error) {
...
type NullableUpdatePaymentChannelRequestV4 struct {
	value *UpdatePaymentChannelRequestV4
	isSet bool
}

func (v NullableUpdatePaymentChannelRequestV4) Get() *UpdatePaymentChannelRequestV4 {
	return v.value
}

func (v *NullableUpdatePaymentChannelRequestV4) Set(val *UpdatePaymentChannelRequestV4) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdatePaymentChannelRequestV4) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdatePaymentChannelRequestV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdatePaymentChannelRequestV4(val *UpdatePaymentChannelRequestV4) *NullableUpdatePaymentChannelRequestV4 {
	return &NullableUpdatePaymentChannelRequestV4{value: val, isSet: true}
}

func (v NullableUpdatePaymentChannelRequestV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdatePaymentChannelRequestV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
