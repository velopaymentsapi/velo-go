...
// checks if the PagedUserResponsePage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagedUserResponsePage{}
...
func (o PagedUserResponsePage) MarshalJSON() ([]byte, error) {
...
func (o PagedUserResponsePage) ToMap() (map[string]interface{}, error) {
...
type NullablePagedUserResponsePage struct {
	value *PagedUserResponsePage
	isSet bool
}

func (v NullablePagedUserResponsePage) Get() *PagedUserResponsePage {
	return v.value
}

func (v *NullablePagedUserResponsePage) Set(val *PagedUserResponsePage) {
	v.value = val
	v.isSet = true
}

func (v NullablePagedUserResponsePage) IsSet() bool {
	return v.isSet
}

func (v *NullablePagedUserResponsePage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagedUserResponsePage(val *PagedUserResponsePage) *NullablePagedUserResponsePage {
	return &NullablePagedUserResponsePage{value: val, isSet: true}
}

func (v NullablePagedUserResponsePage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagedUserResponsePage) UnmarshalJSON(src []byte) error {
	v.isSet = true
