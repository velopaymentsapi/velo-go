...
// checks if the SourceAccountSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceAccountSummary{}

// SourceAccountSummary struct for SourceAccountSummary
...
func (o SourceAccountSummary) MarshalJSON() ([]byte, error) {
...
func (o SourceAccountSummary) ToMap() (map[string]interface{}, error) {
...
type NullableSourceAccountSummary struct {
	value *SourceAccountSummary
	isSet bool
}

func (v NullableSourceAccountSummary) Get() *SourceAccountSummary {
	return v.value
}

func (v *NullableSourceAccountSummary) Set(val *SourceAccountSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableSourceAccountSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableSourceAccountSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSourceAccountSummary(val *SourceAccountSummary) *NullableSourceAccountSummary {
	return &NullableSourceAccountSummary{value: val, isSet: true}
}

func (v NullableSourceAccountSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSourceAccountSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
