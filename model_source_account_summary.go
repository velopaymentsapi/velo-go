...
type SourceAccountSummary struct {
	...
	Currency *PaymentAuditCurrency `json:"currency,omitempty"`
}
...
// SetCurrency gets a reference to the given PaymentAuditCurrency and assigns it to the Currency field.
