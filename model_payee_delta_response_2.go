...
func (o *PayeeDeltaResponse2) GetPage() PayeeDeltaResponsePage {
	if o == nil || o.Page == nil {
		var ret PayeeDeltaResponsePage
		return ret
	}
	return *o.Page
}
...
// SetPage gets a reference to the given PayeeDeltaResponsePage and assigns it to the Page field.
...
func (o *PayeeDeltaResponse2) GetLinks() []PayeeDeltaResponse2Links {
	if o == nil || o.Links == nil {
		var ret []PayeeDeltaResponse2Links
		return ret
	}
	return o.Links
}
...
// SetLinks gets a reference to the given []PayeeDeltaResponse2Links and assigns it to the Links field.
...
// SetContent gets a reference to the given []PayeeDelta2 and assigns it to the Content field.
func (o *PayeeDeltaResponse2) SetContent(v []PayeeDelta2) {
	o.Content = v
}

func (o PayeeDeltaResponse2) MarshalJSON() ([]byte, error) {
...
type NullablePayeeDeltaResponse2 struct {
	value *PayeeDeltaResponse2
	isSet bool
}

func (v NullablePayeeDeltaResponse2) Get() *PayeeDeltaResponse2 {
	return v.value
}

func (v *NullablePayeeDeltaResponse2) Set(val *PayeeDeltaResponse2) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeDeltaResponse2) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeDeltaResponse2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeDeltaResponse2(val *PayeeDeltaResponse2) *NullablePayeeDeltaResponse2 {
	return &NullablePayeeDeltaResponse2{value: val, isSet: true}
}

func (v NullablePayeeDeltaResponse2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeDeltaResponse2) UnmarshalJSON(src []byte) error {
	v.isSet = true
