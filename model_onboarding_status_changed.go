...
// checks if the OnboardingStatusChanged type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OnboardingStatusChanged{}

// OnboardingStatusChanged Base type for all onboarding status changed events
type OnboardingStatusChanged struct {
	...
	Reasons []PayeeEventAllOfReasons `json:"reasons,omitempty"`
}
...
func (o *OnboardingStatusChanged) GetReasons() []PayeeEventAllOfReasons {
	if o == nil || IsNil(o.Reasons) {
		var ret []PayeeEventAllOfReasons
		return ret
	}
	return o.Reasons
}
...
// SetReasons gets a reference to the given []PayeeEventAllOfReasons and assigns it to the Reasons field.
func (o *OnboardingStatusChanged) SetReasons(v []PayeeEventAllOfReasons) {
	o.Reasons = v
}

func (o OnboardingStatusChanged) MarshalJSON() ([]byte, error) {
...
func (o OnboardingStatusChanged) ToMap() (map[string]interface{}, error) {
...
type NullableOnboardingStatusChanged struct {
	value *OnboardingStatusChanged
	isSet bool
}

func (v NullableOnboardingStatusChanged) Get() *OnboardingStatusChanged {
	return v.value
}

func (v *NullableOnboardingStatusChanged) Set(val *OnboardingStatusChanged) {
	v.value = val
	v.isSet = true
}

func (v NullableOnboardingStatusChanged) IsSet() bool {
	return v.isSet
}

func (v *NullableOnboardingStatusChanged) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOnboardingStatusChanged(val *OnboardingStatusChanged) *NullableOnboardingStatusChanged {
	return &NullableOnboardingStatusChanged{value: val, isSet: true}
}

func (v NullableOnboardingStatusChanged) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOnboardingStatusChanged) UnmarshalJSON(src []byte) error {
	v.isSet = true
