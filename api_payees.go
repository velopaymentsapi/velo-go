...
*/
func (a *PayeesApiService) GetPayeeByIdV3(ctx _context.Context, payeeId string, localVarOptionals *GetPayeeByIdV3Opts) (PayeeDetailResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
type ListPayeesV3Opts struct {
    WatchlistStatus optional.Interface
 ...
 * @param "WatchlistStatus" (optional.Interface of WatchlistStatus) -  The watchlistStatus of the payees.
 * @param "Disabled" (optional.Bool) -  Payee disabled
 * @param "OnboardedStatus" (optional.Interface of OnboardedStatus) -  The onboarded status of the payees.
 * @param "Email" (optional.Interface of string) -  Email address
 * @param "DisplayName" (optional.String) -  The display name of the payees.
 * @param "RemoteId" (optional.String) -  The remote id of the payees.
...
func (a *PayeesApiService) ListPayeesV3(ctx _context.Context, payorId string, localVarOptionals *ListPayeesV3Opts) (PagedPayeeResponse2, *_nethttp.Response, error) {
	...
	localVarQueryParams.Add("payorId", parameterToString(payorId, ""))
	if localVarOptionals != nil && localVarOptionals.WatchlistStatus.IsSet() {
		localVarQueryParams.Add("watchlistStatus", parameterToString(localVarOptionals.WatchlistStatus.Value(), ""))
	}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param payeeId The UUID of the payee.
 * @param updatePayeeDetailsRequest Request to update payee details
*/
func (a *PayeesApiService) PayeeDetailsUpdateV3(ctx _context.Context, payeeId string, updatePayeeDetailsRequest UpdatePayeeDetailsRequest) (*_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/payees/{payeeId}/payeeDetailsUpdate"
	localVarPath = strings.Replace(localVarPath, "{"+"payeeId"+"}", _neturl.PathEscape(parameterToString(payeeId, "")) , -1)
	...
	// body params
	localVarPostBody = &updatePayeeDetailsRequest
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
