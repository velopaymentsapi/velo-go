...
/*
DeletePayeeById Delete Payee by Id
...
*/
func (a *PayeesApiService) DeletePayeeById(ctx _context.Context, payeeId string) (*_nethttp.Response, error) {
	var (
...
// GetPayeeByIdOpts Optional parameters for the method 'GetPayeeById'
type GetPayeeByIdOpts struct {
    Sensitive optional.Bool
}

/*
GetPayeeById Get Payee by Id
Get Payee by Id
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param payeeId The UUID of the payee.
 * @param optional nil or *GetPayeeByIdOpts - Optional Parameters:
...
@return Payee
*/
func (a *PayeesApiService) GetPayeeById(ctx _context.Context, payeeId string, localVarOptionals *GetPayeeByIdOpts) (Payee, *_nethttp.Response, error) {
	var (
...
// ListPayeesOpts Optional parameters for the method 'ListPayees'
type ListPayeesOpts struct {
...
/*
ListPayees List Payees
Get a paginated response listing the payees for a payor.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param payorId The account owner Payor ID
 * @param optional nil or *ListPayeesOpts - Optional Parameters:
 ...
 * @param "PayeeCountry" (optional.String) -  The country of the payees.
 * @param "Page" (optional.Int32) -  Page number. Default is 1.
...
*/
func (a *PayeesApiService) ListPayees(ctx _context.Context, payorId string, localVarOptionals *ListPayeesOpts) (PagedPayeeResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
