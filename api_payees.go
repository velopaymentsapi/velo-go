...
type ApiDeletePayeeByIdV1Request struct {
...
func (r ApiDeletePayeeByIdV1Request) Execute() (*_nethttp.Response, error) {
	return r.ApiService.DeletePayeeByIdV1Execute(r)
}
 ...
 * @return ApiDeletePayeeByIdV1Request
 */
func (a *PayeesApiService) DeletePayeeByIdV1(ctx _context.Context, payeeId string) ApiDeletePayeeByIdV1Request {
	return ApiDeletePayeeByIdV1Request{
		ApiService: a,
		ctx: ctx,
		payeeId: payeeId,
 ...
 */
func (a *PayeesApiService) DeletePayeeByIdV1Execute(r ApiDeletePayeeByIdV1Request) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PayeesApiService.DeletePayeeByIdV1")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/payees/{payeeId}"
...
type ApiGetPayeeByIdV1Request struct {
	ctx _context.Context
	ApiService *PayeesApiService
	payeeId string
	sensitive *bool
...
func (r ApiGetPayeeByIdV1Request) Sensitive(sensitive bool) ApiGetPayeeByIdV1Request {
	r.sensitive = &sensitive
	return r
}

func (r ApiGetPayeeByIdV1Request) Execute() (Payee, *_nethttp.Response, error) {
	return r.ApiService.GetPayeeByIdV1Execute(r)
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param payeeId The UUID of the payee.
 * @return ApiGetPayeeByIdV1Request
 */
func (a *PayeesApiService) GetPayeeByIdV1(ctx _context.Context, payeeId string) ApiGetPayeeByIdV1Request {
	return ApiGetPayeeByIdV1Request{
		ApiService: a,
		ctx: ctx,
		payeeId: payeeId,
 ...
 * @return Payee
 */
func (a *PayeesApiService) GetPayeeByIdV1Execute(r ApiGetPayeeByIdV1Request) (Payee, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PayeesApiService.GetPayeeByIdV1")
	if err != nil {
...
type ApiGetPayeeByIdV2Request struct {
	ctx _context.Context
	ApiService *PayeesApiService
	payeeId string
	sensitive *bool
...
func (r ApiGetPayeeByIdV2Request) Sensitive(sensitive bool) ApiGetPayeeByIdV2Request {
	r.sensitive = &sensitive
	return r
}

func (r ApiGetPayeeByIdV2Request) Execute() (PayeeResponseV2, *_nethttp.Response, error) {
	return r.ApiService.GetPayeeByIdV2Execute(r)
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param payeeId The UUID of the payee.
 * @return ApiGetPayeeByIdV2Request
 */
func (a *PayeesApiService) GetPayeeByIdV2(ctx _context.Context, payeeId string) ApiGetPayeeByIdV2Request {
	return ApiGetPayeeByIdV2Request{
		ApiService: a,
		ctx: ctx,
		payeeId: payeeId,
 ...
 */
func (a *PayeesApiService) GetPayeeByIdV2Execute(r ApiGetPayeeByIdV2Request) (PayeeResponseV2, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PayeesApiService.GetPayeeByIdV2")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/payees/{payeeId}"
	localVarPath = strings.Replace(localVarPath, "{"+"payeeId"+"}", _neturl.PathEscape(parameterToString(r.payeeId, "")), -1)
...
type ApiListPayeeChangesRequest struct {
	ctx _context.Context
	ApiService *PayeesApiService
	payorId *string
...
func (r ApiListPayeeChangesRequest) PayorId(payorId string) ApiListPayeeChangesRequest {
	r.payorId = &payorId
	return r
}
func (r ApiListPayeeChangesRequest) UpdatedSince(updatedSince time.Time) ApiListPayeeChangesRequest {
	r.updatedSince = &updatedSince
	return r
}
func (r ApiListPayeeChangesRequest) Page(page int32) ApiListPayeeChangesRequest {
	r.page = &page
	return r
}
func (r ApiListPayeeChangesRequest) PageSize(pageSize int32) ApiListPayeeChangesRequest {
	r.pageSize = &pageSize
	return r
}

func (r ApiListPayeeChangesRequest) Execute() (PayeeDeltaResponse, *_nethttp.Response, error) {
	return r.ApiService.ListPayeeChangesExecute(r)
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiListPayeeChangesRequest
 */
func (a *PayeesApiService) ListPayeeChanges(ctx _context.Context) ApiListPayeeChangesRequest {
	return ApiListPayeeChangesRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *PayeesApiService) ListPayeeChangesExecute(r ApiListPayeeChangesRequest) (PayeeDeltaResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PayeesApiService.ListPayeeChanges")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/deltas/payees"
...
func (r ApiListPayeeChangesV3Request) Execute() (PayeeDeltaResponse2, *_nethttp.Response, error) {
 ...
 */
func (a *PayeesApiService) ListPayeeChangesV3Execute(r ApiListPayeeChangesV3Request) (PayeeDeltaResponse2, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
type ApiListPayeesV1Request struct {
	ctx _context.Context
	ApiService *PayeesApiService
	payorId *string
...
func (r ApiListPayeesV1Request) PayorId(payorId string) ApiListPayeesV1Request {
	r.payorId = &payorId
	return r
}
func (r ApiListPayeesV1Request) OfacStatus(ofacStatus OfacStatus) ApiListPayeesV1Request {
	r.ofacStatus = &ofacStatus
	return r
}
func (r ApiListPayeesV1Request) OnboardedStatus(onboardedStatus OnboardedStatus) ApiListPayeesV1Request {
	r.onboardedStatus = &onboardedStatus
	return r
}
func (r ApiListPayeesV1Request) Email(email string) ApiListPayeesV1Request {
	r.email = &email
	return r
}
func (r ApiListPayeesV1Request) DisplayName(displayName string) ApiListPayeesV1Request {
	r.displayName = &displayName
	return r
}
func (r ApiListPayeesV1Request) RemoteId(remoteId string) ApiListPayeesV1Request {
	r.remoteId = &remoteId
	return r
}
func (r ApiListPayeesV1Request) PayeeType(payeeType PayeeType) ApiListPayeesV1Request {
	r.payeeType = &payeeType
	return r
}
func (r ApiListPayeesV1Request) PayeeCountry(payeeCountry string) ApiListPayeesV1Request {
	r.payeeCountry = &payeeCountry
	return r
}
func (r ApiListPayeesV1Request) Page(page int32) ApiListPayeesV1Request {
	r.page = &page
	return r
}
func (r ApiListPayeesV1Request) PageSize(pageSize int32) ApiListPayeesV1Request {
	r.pageSize = &pageSize
	return r
}
func (r ApiListPayeesV1Request) Sort(sort string) ApiListPayeesV1Request {
	r.sort = &sort
	return r
}

func (r ApiListPayeesV1Request) Execute() (PagedPayeeResponse, *_nethttp.Response, error) {
	return r.ApiService.ListPayeesV1Execute(r)
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiListPayeesV1Request
 */
func (a *PayeesApiService) ListPayeesV1(ctx _context.Context) ApiListPayeesV1Request {
	return ApiListPayeesV1Request{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *PayeesApiService) ListPayeesV1Execute(r ApiListPayeesV1Request) (PagedPayeeResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PayeesApiService.ListPayeesV1")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/payees"
...
func (r ApiListPayeesV3Request) Execute() (PagedPayeeResponse2, *_nethttp.Response, error) {
 ...
 */
func (a *PayeesApiService) ListPayeesV3Execute(r ApiListPayeesV3Request) (PagedPayeeResponse2, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
type ApiV1PayeesPayeeIdRemoteIdUpdatePostRequest struct {
	ctx _context.Context
	ApiService *PayeesApiService
	payeeId string
...
func (r ApiV1PayeesPayeeIdRemoteIdUpdatePostRequest) UpdateRemoteIdRequest(updateRemoteIdRequest UpdateRemoteIdRequest) ApiV1PayeesPayeeIdRemoteIdUpdatePostRequest {
	r.updateRemoteIdRequest = &updateRemoteIdRequest
	return r
}

func (r ApiV1PayeesPayeeIdRemoteIdUpdatePostRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.V1PayeesPayeeIdRemoteIdUpdatePostExecute(r)
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param payeeId The UUID of the payee.
 * @return ApiV1PayeesPayeeIdRemoteIdUpdatePostRequest
 */
func (a *PayeesApiService) V1PayeesPayeeIdRemoteIdUpdatePost(ctx _context.Context, payeeId string) ApiV1PayeesPayeeIdRemoteIdUpdatePostRequest {
	return ApiV1PayeesPayeeIdRemoteIdUpdatePostRequest{
		ApiService: a,
		ctx: ctx,
		payeeId: payeeId,
 ...
 * Execute executes the request
 */
func (a *PayeesApiService) V1PayeesPayeeIdRemoteIdUpdatePostExecute(r ApiV1PayeesPayeeIdRemoteIdUpdatePostRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PayeesApiService.V1PayeesPayeeIdRemoteIdUpdatePost")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/payees/{payeeId}/remoteIdUpdate"
	localVarPath = strings.Replace(localVarPath, "{"+"payeeId"+"}", _neturl.PathEscape(parameterToString(r.payeeId, "")), -1)
...
func (r ApiV4PayeesPayeeIdRemoteIdUpdatePostRequest) UpdateRemoteIdRequest(updateRemoteIdRequest UpdateRemoteIdRequest) ApiV4PayeesPayeeIdRemoteIdUpdatePostRequest {
	r.updateRemoteIdRequest = &updateRemoteIdRequest
	return r
}
