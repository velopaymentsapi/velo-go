...
func (o *PayeeDelta2) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o PayeeDelta2) MarshalJSON() ([]byte, error) {
...
type NullablePayeeDelta2 struct {
	value *PayeeDelta2
	isSet bool
}

func (v NullablePayeeDelta2) Get() *PayeeDelta2 {
	return v.value
}

func (v *NullablePayeeDelta2) Set(val *PayeeDelta2) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeDelta2) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeDelta2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeDelta2(val *PayeeDelta2) *NullablePayeeDelta2 {
	return &NullablePayeeDelta2{value: val, isSet: true}
}

func (v NullablePayeeDelta2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeDelta2) UnmarshalJSON(src []byte) error {
	v.isSet = true
