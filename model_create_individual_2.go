...
func (o CreateIndividual2) MarshalJSON() ([]byte, error) {
...
type NullableCreateIndividual2 struct {
	value *CreateIndividual2
	isSet bool
}

func (v NullableCreateIndividual2) Get() *CreateIndividual2 {
	return v.value
}

func (v *NullableCreateIndividual2) Set(val *CreateIndividual2) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateIndividual2) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateIndividual2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateIndividual2(val *CreateIndividual2) *NullableCreateIndividual2 {
	return &NullableCreateIndividual2{value: val, isSet: true}
}

func (v NullableCreateIndividual2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateIndividual2) UnmarshalJSON(src []byte) error {
	v.isSet = true
