...
// checks if the PayoutPrincipal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayoutPrincipal{}
...
func (o PayoutPrincipal) MarshalJSON() ([]byte, error) {
...
func (o PayoutPrincipal) ToMap() (map[string]interface{}, error) {
...
type NullablePayoutPrincipal struct {
	value *PayoutPrincipal
	isSet bool
}

func (v NullablePayoutPrincipal) Get() *PayoutPrincipal {
	return v.value
}

func (v *NullablePayoutPrincipal) Set(val *PayoutPrincipal) {
	v.value = val
	v.isSet = true
}

func (v NullablePayoutPrincipal) IsSet() bool {
	return v.isSet
}

func (v *NullablePayoutPrincipal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayoutPrincipal(val *PayoutPrincipal) *NullablePayoutPrincipal {
	return &NullablePayoutPrincipal{value: val, isSet: true}
}

func (v NullablePayoutPrincipal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayoutPrincipal) UnmarshalJSON(src []byte) error {
	v.isSet = true
