...
// checks if the InlineResponse409 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineResponse409{}
...
func (o *InlineResponse409) SetCorrelationIdNil() {
...
func (o InlineResponse409) ToMap() (map[string]interface{}, error) {
