...
type InlineResponse412 struct {
	// one or more errors
	Errors []InlineResponse412Errors `json:"errors,omitempty"`
...
func (o *InlineResponse412) GetErrors() []InlineResponse412Errors {
	if o == nil  {
		var ret []InlineResponse412Errors
		return ret
	}
	return o.Errors
}
...
// SetErrors gets a reference to the given []InlineResponse412Errors and assigns it to the Errors field.
