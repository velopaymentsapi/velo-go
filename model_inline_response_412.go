...
// checks if the InlineResponse412 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineResponse412{}

// InlineResponse412 struct for InlineResponse412
...
func (o *InlineResponse412) SetCorrelationIdNil() {
...
func (o InlineResponse412) MarshalJSON() ([]byte, error) {
...
func (o InlineResponse412) ToMap() (map[string]interface{}, error) {
...
type NullableInlineResponse412 struct {
	value *InlineResponse412
	isSet bool
}

func (v NullableInlineResponse412) Get() *InlineResponse412 {
	return v.value
}

func (v *NullableInlineResponse412) Set(val *InlineResponse412) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse412) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse412) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse412(val *InlineResponse412) *NullableInlineResponse412 {
	return &NullableInlineResponse412{value: val, isSet: true}
}

func (v NullableInlineResponse412) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse412) UnmarshalJSON(src []byte) error {
	v.isSet = true
