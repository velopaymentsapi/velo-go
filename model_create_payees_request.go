...
func (o CreatePayeesRequest) MarshalJSON() ([]byte, error) {
...
type NullableCreatePayeesRequest struct {
	value *CreatePayeesRequest
	isSet bool
}

func (v NullableCreatePayeesRequest) Get() *CreatePayeesRequest {
	return v.value
}

func (v *NullableCreatePayeesRequest) Set(val *CreatePayeesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePayeesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePayeesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePayeesRequest(val *CreatePayeesRequest) *NullableCreatePayeesRequest {
	return &NullableCreatePayeesRequest{value: val, isSet: true}
}

func (v NullableCreatePayeesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePayeesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
