...
func (o CreateIndividual) MarshalJSON() ([]byte, error) {
...
type NullableCreateIndividual struct {
	value *CreateIndividual
	isSet bool
}

func (v NullableCreateIndividual) Get() *CreateIndividual {
	return v.value
}

func (v *NullableCreateIndividual) Set(val *CreateIndividual) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateIndividual) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateIndividual) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateIndividual(val *CreateIndividual) *NullableCreateIndividual {
	return &NullableCreateIndividual{value: val, isSet: true}
}

func (v NullableCreateIndividual) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateIndividual) UnmarshalJSON(src []byte) error {
	v.isSet = true
