...
// SetFailures gets a reference to the given []FailedSubmission and assigns it to the Failures field.
func (o *QueryBatchResponse) SetFailures(v []FailedSubmission) {
	o.Failures = &v
}

func (o QueryBatchResponse) MarshalJSON() ([]byte, error) {
...
type NullableQueryBatchResponse struct {
	value *QueryBatchResponse
	isSet bool
}

func (v NullableQueryBatchResponse) Get() *QueryBatchResponse {
	return v.value
}

func (v *NullableQueryBatchResponse) Set(val *QueryBatchResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryBatchResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryBatchResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryBatchResponse(val *QueryBatchResponse) *NullableQueryBatchResponse {
	return &NullableQueryBatchResponse{value: val, isSet: true}
}

func (v NullableQueryBatchResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryBatchResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
