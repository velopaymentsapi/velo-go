...
func NewPagedPayeeInvitationStatusResponse2() *PagedPayeeInvitationStatusResponse2 {
	this := PagedPayeeInvitationStatusResponse2{}
	return &this
}
...
func (o *PagedPayeeInvitationStatusResponse2) GetContent() []PayeeInvitationStatusResponse2 {
	if o == nil || o.Content == nil {
		var ret []PayeeInvitationStatusResponse2
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []PayeeInvitationStatusResponse2 and assigns it to the Content field.
func (o *PagedPayeeInvitationStatusResponse2) SetContent(v []PayeeInvitationStatusResponse2) {
	o.Content = v
}

func (o PagedPayeeInvitationStatusResponse2) MarshalJSON() ([]byte, error) {
...
type NullablePagedPayeeInvitationStatusResponse2 struct {
	value *PagedPayeeInvitationStatusResponse2
	isSet bool
}

func (v NullablePagedPayeeInvitationStatusResponse2) Get() *PagedPayeeInvitationStatusResponse2 {
	return v.value
}

func (v *NullablePagedPayeeInvitationStatusResponse2) Set(val *PagedPayeeInvitationStatusResponse2) {
	v.value = val
	v.isSet = true
}

func (v NullablePagedPayeeInvitationStatusResponse2) IsSet() bool {
	return v.isSet
}

func (v *NullablePagedPayeeInvitationStatusResponse2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagedPayeeInvitationStatusResponse2(val *PagedPayeeInvitationStatusResponse2) *NullablePagedPayeeInvitationStatusResponse2 {
	return &NullablePagedPayeeInvitationStatusResponse2{value: val, isSet: true}
}

func (v NullablePagedPayeeInvitationStatusResponse2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagedPayeeInvitationStatusResponse2) UnmarshalJSON(src []byte) error {
	v.isSet = true
