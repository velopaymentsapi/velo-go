...
func (r ApiGetPayeesInvitationStatusV3Request) Execute() (PagedPayeeInvitationStatusResponse, *_nethttp.Response, error) {
 ...
 */
func (a *PayeeInvitationApiService) GetPayeesInvitationStatusV3Execute(r ApiGetPayeesInvitationStatusV3Request) (PagedPayeeInvitationStatusResponse, *_nethttp.Response, error) {
	var (
...
func (r ApiQueryBatchStatusV3Request) Execute() (QueryBatchResponse, *_nethttp.Response, error) {
 ...
 */
func (a *PayeeInvitationApiService) QueryBatchStatusV3Execute(r ApiQueryBatchStatusV3Request) (QueryBatchResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiV3CreatePayeeRequest) Execute() (CreatePayeesCSVResponse, *_nethttp.Response, error) {
 ...
 */
func (a *PayeeInvitationApiService) V3CreatePayeeExecute(r ApiV3CreatePayeeRequest) (CreatePayeesCSVResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
