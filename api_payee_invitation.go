...
func (a *PayeeInvitationApiService) GetPayeesInvitationStatus(ctx _context.Context, payorId string) (InvitationStatusResponse, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"payorId"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", payorId)), -1)
...
func (a *PayeeInvitationApiService) ResendPayeeInvite(ctx _context.Context, payeeId string, invitePayeeRequest InvitePayeeRequest) (InvitationStatusResponse, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"payeeId"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", payeeId)), -1)
...
/*
V2CreatePayee Intiate Payee Creation
