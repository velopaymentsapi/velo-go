...
func NewPagedPayeeResponse2Summary() *PagedPayeeResponse2Summary {
	this := PagedPayeeResponse2Summary{}
	return &this
}
...
func (o PagedPayeeResponse2Summary) MarshalJSON() ([]byte, error) {
...
type NullablePagedPayeeResponse2Summary struct {
	value *PagedPayeeResponse2Summary
	isSet bool
}

func (v NullablePagedPayeeResponse2Summary) Get() *PagedPayeeResponse2Summary {
	return v.value
}

func (v *NullablePagedPayeeResponse2Summary) Set(val *PagedPayeeResponse2Summary) {
	v.value = val
	v.isSet = true
}

func (v NullablePagedPayeeResponse2Summary) IsSet() bool {
	return v.isSet
}

func (v *NullablePagedPayeeResponse2Summary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagedPayeeResponse2Summary(val *PagedPayeeResponse2Summary) *NullablePagedPayeeResponse2Summary {
	return &NullablePagedPayeeResponse2Summary{value: val, isSet: true}
}

func (v NullablePagedPayeeResponse2Summary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagedPayeeResponse2Summary) UnmarshalJSON(src []byte) error {
	v.isSet = true
