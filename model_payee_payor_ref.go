...
// SetInvitationStatus gets a reference to the given InvitationStatus and assigns it to the InvitationStatus field.
...
func (o *PayeePayorRef) SetInvitationStatusTimestampNil() {
...
func (o *PayeePayorRef) GetPayableIssues() []PayableIssue2 {
	if o == nil || o.PayableIssues == nil {
		var ret []PayableIssue2
		return ret
	}
...
// SetPayableIssues gets a reference to the given []PayableIssue2 and assigns it to the PayableIssues field.
func (o *PayeePayorRef) SetPayableIssues(v []PayableIssue2) {
	o.PayableIssues = &v
}

func (o PayeePayorRef) MarshalJSON() ([]byte, error) {
	...
	if o.PayableStatus != nil {
		toSerialize["payableStatus"] = o.PayableStatus
	}
	if o.PayableIssues != nil {
		toSerialize["payableIssues"] = o.PayableIssues
	}
	return json.Marshal(toSerialize)
}

type NullablePayeePayorRef struct {
	value *PayeePayorRef
	isSet bool
}

func (v NullablePayeePayorRef) Get() *PayeePayorRef {
	return v.value
}

func (v *NullablePayeePayorRef) Set(val *PayeePayorRef) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeePayorRef) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeePayorRef) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeePayorRef(val *PayeePayorRef) *NullablePayeePayorRef {
	return &NullablePayeePayorRef{value: val, isSet: true}
}

func (v NullablePayeePayorRef) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeePayorRef) UnmarshalJSON(src []byte) error {
	v.isSet = true
