...
func (o InlineResponse401Errors) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse401Errors struct {
	value *InlineResponse401Errors
	isSet bool
}

func (v NullableInlineResponse401Errors) Get() *InlineResponse401Errors {
	return v.value
}

func (v *NullableInlineResponse401Errors) Set(val *InlineResponse401Errors) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse401Errors) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse401Errors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse401Errors(val *InlineResponse401Errors) *NullableInlineResponse401Errors {
	return &NullableInlineResponse401Errors{value: val, isSet: true}
}

func (v NullableInlineResponse401Errors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse401Errors) UnmarshalJSON(src []byte) error {
	v.isSet = true
