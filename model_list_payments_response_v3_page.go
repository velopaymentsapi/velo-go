...
// checks if the ListPaymentsResponseV3Page type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListPaymentsResponseV3Page{}
...
func (o ListPaymentsResponseV3Page) ToMap() (map[string]interface{}, error) {
