...
// checks if the PayorLinksResponseLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayorLinksResponseLinks{}
...
// GetFromPayorId returns the FromPayorId field value
func (o *PayorLinksResponseLinks) GetFromPayorId() string {
	...
	return o.FromPayorId
}

// GetFromPayorIdOk returns a tuple with the FromPayorId field value
// and a boolean to check if the value has been set.
func (o *PayorLinksResponseLinks) GetFromPayorIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.FromPayorId, true
}

// SetFromPayorId sets field value
...
// GetToPayorId returns the ToPayorId field value
...
// GetToPayorIdOk returns a tuple with the ToPayorId field value
// and a boolean to check if the value has been set.
func (o *PayorLinksResponseLinks) GetToPayorIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ToPayorId, true
}

// SetToPayorId sets field value
func (o *PayorLinksResponseLinks) SetToPayorId(v string) {
	o.ToPayorId = v
}

func (o PayorLinksResponseLinks) MarshalJSON() ([]byte, error) {
...
func (o PayorLinksResponseLinks) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["linkId"] = o.LinkId
	toSerialize["fromPayorId"] = o.FromPayorId
	toSerialize["linkType"] = o.LinkType
	toSerialize["toPayorId"] = o.ToPayorId
	return toSerialize, nil
}

type NullablePayorLinksResponseLinks struct {
	value *PayorLinksResponseLinks
	isSet bool
}

func (v NullablePayorLinksResponseLinks) Get() *PayorLinksResponseLinks {
	return v.value
}

func (v *NullablePayorLinksResponseLinks) Set(val *PayorLinksResponseLinks) {
	v.value = val
	v.isSet = true
}

func (v NullablePayorLinksResponseLinks) IsSet() bool {
	return v.isSet
}

func (v *NullablePayorLinksResponseLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayorLinksResponseLinks(val *PayorLinksResponseLinks) *NullablePayorLinksResponseLinks {
	return &NullablePayorLinksResponseLinks{value: val, isSet: true}
}

func (v NullablePayorLinksResponseLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayorLinksResponseLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
