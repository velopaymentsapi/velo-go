...
// ExportTransactionsCSVOpts Optional parameters for the method 'ExportTransactionsCSV'
type ExportTransactionsCSVOpts struct {
...
/*
ExportTransactionsCSV Export Transactions
Download a CSV file containing payments in a date range. Uses Transfer-Encoding - chunked to stream to the client. Date range is inclusive of both the start and end dates.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ExportTransactionsCSVOpts - Optional Parameters:
...
@return string
*/
func (a *PaymentAuditServiceApiService) ExportTransactionsCSV(ctx _context.Context, localVarOptionals *ExportTransactionsCSVOpts) (string, *_nethttp.Response, error) {
	var (
...
*/
func (a *PaymentAuditServiceApiService) GetFundings(ctx _context.Context, localVarOptionals *GetFundingsOpts) (GetFundingsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *PaymentAuditServiceApiService) GetPaymentDetails(ctx _context.Context, paymentId string, localVarOptionals *GetPaymentDetailsOpts) (PaymentResponseV3, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"paymentId"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", paymentId)), -1)
...
// GetPayoutsForPayorOpts Optional parameters for the method 'GetPayoutsForPayor'
type GetPayoutsForPayorOpts struct {
...
/*
GetPayoutsForPayor Get Payouts for Payor
Get List of payouts for payor 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param payorId The account owner Payor ID
 * @param optional nil or *GetPayoutsForPayorOpts - Optional Parameters:
...
*/
func (a *PaymentAuditServiceApiService) GetPayoutsForPayor(ctx _context.Context, payorId string, localVarOptionals *GetPayoutsForPayorOpts) (GetPayoutsResponseV3, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *PaymentAuditServiceApiService) GetPayoutsForPayorV4(ctx _context.Context, payorId string, localVarOptionals *GetPayoutsForPayorV4Opts) (GetPayoutsResponseV4, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return ListPaymentsResponse
*/
func (a *PaymentAuditServiceApiService) ListPaymentsAuditV4(ctx _context.Context, localVarOptionals *ListPaymentsAuditV4Opts) (ListPaymentsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
