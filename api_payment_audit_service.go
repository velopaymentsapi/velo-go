 ...
 * @param "PayorId" (optional.Interface of string) -  <p>The Payor ID for whom you wish to run the report.</p> <p>For a Payor requesting the report, this could be their exact Payor, or it could be a child/descendant Payor.</p> 
 * @param "StartDate" (optional.String) -  Start date, inclusive. Format is YYYY-MM-DD
 * @param "EndDate" (optional.String) -  End date, inclusive. Format is YYYY-MM-DD
...
*/
func (a *PaymentAuditServiceApiService) GetFundingsV1(ctx _context.Context, payorId string, localVarOptionals *GetFundingsV1Opts) (GetFundingsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// GetFundingsV4Opts Optional parameters for the method 'GetFundingsV4'
type GetFundingsV4Opts struct {
    Page optional.Int32
    PageSize optional.Int32
    Sort optional.String
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param payorId The account owner Payor ID
 * @param optional nil or *GetFundingsV4Opts - Optional Parameters:
 * @param "Page" (optional.Int32) -  Page number. Default is 1.
 * @param "PageSize" (optional.Int32) -  The number of results to return in a page
 * @param "Sort" (optional.String) -  List of sort fields. Example: ```?sort=destinationCurrency:asc,destinationAmount:asc``` Default is no sort. The supported sort fields are: dateTime and amount. 
@return GetFundingsResponse
*/
func (a *PaymentAuditServiceApiService) GetFundingsV4(ctx _context.Context, payorId string, localVarOptionals *GetFundingsV4Opts) (GetFundingsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v4/paymentaudit/fundings"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
 ...
 * @param "Page" (optional.Int32) -  Page number. Default is 1.
 * @param "PageSize" (optional.Int32) -  The number of results to return in a page
 * @param "Sort" (optional.String) -  <p>List of sort fields (e.g. ?sort=submittedDateTime:asc,status:asc). Default is sort by remoteId</p> <p>The supported sort fields are: sourceAmount, sourceCurrency, paymentAmount, paymentCurrency, routingNumber, accountNumber, remoteId, submittedDateTime and status</p> 
 * @param "Sensitive" (optional.Bool) -  Optional. If omitted or set to false, any Personal Identifiable Information (PII) values are returned masked. If set to true, and you have permission, the PII values will be returned as their original unmasked values. 
...
*/
func (a *PaymentAuditServiceApiService) GetPayoutStatsV1(ctx _context.Context, localVarOptionals *GetPayoutStatsV1Opts) (GetPayoutStatistics, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// GetPayoutStatsV4Opts Optional parameters for the method 'GetPayoutStatsV4'
type GetPayoutStatsV4Opts struct {
    PayorId optional.Interface
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetPayoutStatsV4Opts - Optional Parameters:
 * @param "PayorId" (optional.Interface of string) -  The account owner Payor ID. Required for external users.
@return GetPayoutStatistics
*/
func (a *PaymentAuditServiceApiService) GetPayoutStatsV4(ctx _context.Context, localVarOptionals *GetPayoutStatsV4Opts) (GetPayoutStatistics, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v4/paymentaudit/payoutStatistics"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
// ListPaymentChangesV4Opts Optional parameters for the method 'ListPaymentChangesV4'
type ListPaymentChangesV4Opts struct {
    Page optional.Int32
    PageSize optional.Int32
}
 ...
 * @param payorId The Payor ID to find associated Payments
 * @param updatedSince The updatedSince filter in the format YYYY-MM-DDThh:mm:ss+hh:mm
 * @param optional nil or *ListPaymentChangesV4Opts - Optional Parameters:
 * @param "Page" (optional.Int32) -  Page number. Default is 1.
 * @param "PageSize" (optional.Int32) -  The number of results to return in a page
@return PaymentDeltaResponseV4
*/
func (a *PaymentAuditServiceApiService) ListPaymentChangesV4(ctx _context.Context, payorId string, updatedSince time.Time, localVarOptionals *ListPaymentChangesV4Opts) (PaymentDeltaResponseV4, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v4/payments/deltas"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
*/
func (a *PaymentAuditServiceApiService) ListPaymentsAudit(ctx _context.Context, localVarOptionals *ListPaymentsAuditOpts) (ListPaymentsResponseV3, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
