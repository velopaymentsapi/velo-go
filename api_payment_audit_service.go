...
func (a *PaymentAuditServiceApiService) GetPayoutsForPayorV4Execute(r ApiGetPayoutsForPayorV4Request) (*GetPayoutsResponse, *http.Response, error) {
	...
	if r.scheduledForDateFrom != nil {
		localVarQueryParams.Add("scheduledForDateFrom", parameterToString(*r.scheduledForDateFrom, ""))
	}
	if r.scheduledForDateTo != nil {
		localVarQueryParams.Add("scheduledForDateTo", parameterToString(*r.scheduledForDateTo, ""))
	}
	if r.scheduleStatus != nil {
		localVarQueryParams.Add("scheduleStatus", parameterToString(*r.scheduleStatus, ""))
	}
	if r.page != nil {
		localVarQueryParams.Add("page", parameterToString(*r.page, ""))
	}
