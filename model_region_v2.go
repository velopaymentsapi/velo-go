...
// checks if the RegionV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegionV2{}

// RegionV2 struct for RegionV2
...
func (o RegionV2) MarshalJSON() ([]byte, error) {
...
func (o RegionV2) ToMap() (map[string]interface{}, error) {
...
type NullableRegionV2 struct {
	value *RegionV2
	isSet bool
}

func (v NullableRegionV2) Get() *RegionV2 {
	return v.value
}

func (v *NullableRegionV2) Set(val *RegionV2) {
	v.value = val
	v.isSet = true
}

func (v NullableRegionV2) IsSet() bool {
	return v.isSet
}

func (v *NullableRegionV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegionV2(val *RegionV2) *NullableRegionV2 {
	return &NullableRegionV2{value: val, isSet: true}
}

func (v NullableRegionV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegionV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
