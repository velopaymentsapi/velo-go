...
// checks if the PagedPaymentsResponseV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagedPaymentsResponseV3{}
...
// SetContent gets a reference to the given []PaymentV3 and assigns it to the Content field.
func (o *PagedPaymentsResponseV3) SetContent(v []PaymentV3) {
	o.Content = v
}

func (o PagedPaymentsResponseV3) MarshalJSON() ([]byte, error) {
...
func (o PagedPaymentsResponseV3) ToMap() (map[string]interface{}, error) {
...
type NullablePagedPaymentsResponseV3 struct {
	value *PagedPaymentsResponseV3
	isSet bool
}

func (v NullablePagedPaymentsResponseV3) Get() *PagedPaymentsResponseV3 {
	return v.value
}

func (v *NullablePagedPaymentsResponseV3) Set(val *PagedPaymentsResponseV3) {
	v.value = val
	v.isSet = true
}

func (v NullablePagedPaymentsResponseV3) IsSet() bool {
	return v.isSet
}

func (v *NullablePagedPaymentsResponseV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagedPaymentsResponseV3(val *PagedPaymentsResponseV3) *NullablePagedPaymentsResponseV3 {
	return &NullablePagedPaymentsResponseV3{value: val, isSet: true}
}

func (v NullablePagedPaymentsResponseV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagedPaymentsResponseV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
