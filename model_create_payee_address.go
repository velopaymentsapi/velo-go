...
func (o *CreatePayeeAddress) SetLine2Nil() {
	o.Line2.Set(nil)
}
...
func (o *CreatePayeeAddress) SetLine3Nil() {
	o.Line3.Set(nil)
}
...
func (o *CreatePayeeAddress) SetLine4Nil() {
	o.Line4.Set(nil)
}
...
func (o *CreatePayeeAddress) SetCountyOrProvinceNil() {
...
func (o *CreatePayeeAddress) SetZipOrPostcodeNil() {
...
func (o CreatePayeeAddress) MarshalJSON() ([]byte, error) {
...
type NullableCreatePayeeAddress struct {
	value *CreatePayeeAddress
	isSet bool
}

func (v NullableCreatePayeeAddress) Get() *CreatePayeeAddress {
	return v.value
}

func (v *NullableCreatePayeeAddress) Set(val *CreatePayeeAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePayeeAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePayeeAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePayeeAddress(val *CreatePayeeAddress) *NullableCreatePayeeAddress {
	return &NullableCreatePayeeAddress{value: val, isSet: true}
}

func (v NullableCreatePayeeAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePayeeAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
