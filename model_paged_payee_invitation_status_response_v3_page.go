...
// checks if the PagedPayeeInvitationStatusResponseV3Page type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagedPayeeInvitationStatusResponseV3Page{}

// PagedPayeeInvitationStatusResponseV3Page struct for PagedPayeeInvitationStatusResponseV3Page
...
func NewPagedPayeeInvitationStatusResponseV3Page() *PagedPayeeInvitationStatusResponseV3Page {
	this := PagedPayeeInvitationStatusResponseV3Page{}
	return &this
}
...
func (o PagedPayeeInvitationStatusResponseV3Page) MarshalJSON() ([]byte, error) {
...
func (o PagedPayeeInvitationStatusResponseV3Page) ToMap() (map[string]interface{}, error) {
...
type NullablePagedPayeeInvitationStatusResponseV3Page struct {
	value *PagedPayeeInvitationStatusResponseV3Page
	isSet bool
}

func (v NullablePagedPayeeInvitationStatusResponseV3Page) Get() *PagedPayeeInvitationStatusResponseV3Page {
	return v.value
}

func (v *NullablePagedPayeeInvitationStatusResponseV3Page) Set(val *PagedPayeeInvitationStatusResponseV3Page) {
	v.value = val
	v.isSet = true
}

func (v NullablePagedPayeeInvitationStatusResponseV3Page) IsSet() bool {
	return v.isSet
}

func (v *NullablePagedPayeeInvitationStatusResponseV3Page) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagedPayeeInvitationStatusResponseV3Page(val *PagedPayeeInvitationStatusResponseV3Page) *NullablePagedPayeeInvitationStatusResponseV3Page {
	return &NullablePagedPayeeInvitationStatusResponseV3Page{value: val, isSet: true}
}

func (v NullablePagedPayeeInvitationStatusResponseV3Page) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagedPayeeInvitationStatusResponseV3Page) UnmarshalJSON(src []byte) error {
	v.isSet = true
