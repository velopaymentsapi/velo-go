...
// PayeePayorRef2 struct for PayeePayorRef2
type PayeePayorRef2 struct {
	PayorId *string `json:"payorId,omitempty"`
	RemoteId *string `json:"remoteId,omitempty"`
	InvitationStatus *InvitationStatus2 `json:"invitationStatus,omitempty"`
...
// SetInvitationStatus gets a reference to the given InvitationStatus2 and assigns it to the InvitationStatus field.
...
func (o *PayeePayorRef2) SetInvitationStatusTimestampNil() {
...
func (o PayeePayorRef2) MarshalJSON() ([]byte, error) {
...
type NullablePayeePayorRef2 struct {
	value *PayeePayorRef2
	isSet bool
}

func (v NullablePayeePayorRef2) Get() *PayeePayorRef2 {
	return v.value
}

func (v *NullablePayeePayorRef2) Set(val *PayeePayorRef2) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeePayorRef2) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeePayorRef2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeePayorRef2(val *PayeePayorRef2) *NullablePayeePayorRef2 {
	return &NullablePayeePayorRef2{value: val, isSet: true}
}

func (v NullablePayeePayorRef2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeePayorRef2) UnmarshalJSON(src []byte) error {
	v.isSet = true
