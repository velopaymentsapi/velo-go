...
// SetType gets a reference to the given PayeeType2 and assigns it to the Type field.
...
// SetAddress gets a reference to the given CreatePayeeAddress and assigns it to the Address field.
...
// SetPaymentChannel gets a reference to the given CreatePaymentChannel and assigns it to the PaymentChannel field.
...
func (o *FailedPayee) SetCompanyNil() {
	o.Company.Set(nil)
}
...
// SetIndividual gets a reference to the given CreateIndividual and assigns it to the Individual field.
func (o *FailedPayee) SetIndividual(v CreateIndividual) {
	o.Individual = &v
}

func (o FailedPayee) MarshalJSON() ([]byte, error) {
...
type NullableFailedPayee struct {
	value *FailedPayee
	isSet bool
}

func (v NullableFailedPayee) Get() *FailedPayee {
	return v.value
}

func (v *NullableFailedPayee) Set(val *FailedPayee) {
	v.value = val
	v.isSet = true
}

func (v NullableFailedPayee) IsSet() bool {
	return v.isSet
}

func (v *NullableFailedPayee) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFailedPayee(val *FailedPayee) *NullableFailedPayee {
	return &NullableFailedPayee{value: val, isSet: true}
}

func (v NullableFailedPayee) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFailedPayee) UnmarshalJSON(src []byte) error {
	v.isSet = true
