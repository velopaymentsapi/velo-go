...
// checks if the PayoutScheduleV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayoutScheduleV3{}
...
func (o PayoutScheduleV3) MarshalJSON() ([]byte, error) {
...
func (o PayoutScheduleV3) ToMap() (map[string]interface{}, error) {
...
type NullablePayoutScheduleV3 struct {
	value *PayoutScheduleV3
	isSet bool
}

func (v NullablePayoutScheduleV3) Get() *PayoutScheduleV3 {
	return v.value
}

func (v *NullablePayoutScheduleV3) Set(val *PayoutScheduleV3) {
	v.value = val
	v.isSet = true
}

func (v NullablePayoutScheduleV3) IsSet() bool {
	return v.isSet
}

func (v *NullablePayoutScheduleV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayoutScheduleV3(val *PayoutScheduleV3) *NullablePayoutScheduleV3 {
	return &NullablePayoutScheduleV3{value: val, isSet: true}
}

func (v NullablePayoutScheduleV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayoutScheduleV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
