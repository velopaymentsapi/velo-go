...
// checks if the PagedPayeeInvitationStatusResponseV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagedPayeeInvitationStatusResponseV3{}
...
func NewPagedPayeeInvitationStatusResponseV3() *PagedPayeeInvitationStatusResponseV3 {
	this := PagedPayeeInvitationStatusResponseV3{}
	return &this
}
...
func (o *PagedPayeeInvitationStatusResponseV3) GetContent() []PayeeInvitationStatusResponseV3 {
	if o == nil || IsNil(o.Content) {
		var ret []PayeeInvitationStatusResponseV3
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []PayeeInvitationStatusResponseV3 and assigns it to the Content field.
func (o *PagedPayeeInvitationStatusResponseV3) SetContent(v []PayeeInvitationStatusResponseV3) {
	o.Content = v
}

func (o PagedPayeeInvitationStatusResponseV3) MarshalJSON() ([]byte, error) {
...
func (o PagedPayeeInvitationStatusResponseV3) ToMap() (map[string]interface{}, error) {
...
type NullablePagedPayeeInvitationStatusResponseV3 struct {
	value *PagedPayeeInvitationStatusResponseV3
	isSet bool
}

func (v NullablePagedPayeeInvitationStatusResponseV3) Get() *PagedPayeeInvitationStatusResponseV3 {
	return v.value
}

func (v *NullablePagedPayeeInvitationStatusResponseV3) Set(val *PagedPayeeInvitationStatusResponseV3) {
	v.value = val
	v.isSet = true
}

func (v NullablePagedPayeeInvitationStatusResponseV3) IsSet() bool {
	return v.isSet
}

func (v *NullablePagedPayeeInvitationStatusResponseV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagedPayeeInvitationStatusResponseV3(val *PagedPayeeInvitationStatusResponseV3) *NullablePagedPayeeInvitationStatusResponseV3 {
	return &NullablePagedPayeeInvitationStatusResponseV3{value: val, isSet: true}
}

func (v NullablePagedPayeeInvitationStatusResponseV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagedPayeeInvitationStatusResponseV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
