...
func (a *FundingManagerPrivateApiService) CreateFundingAccount(ctx _context.Context, localVarOptionals *CreateFundingAccountOpts) (*_nethttp.Response, error) {
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.CreateFundingAccountRequest.IsSet() {
		localVarOptionalCreateFundingAccountRequest, localVarOptionalCreateFundingAccountRequestok := localVarOptionals.CreateFundingAccountRequest.Value().(CreateFundingAccountRequest)
		if !localVarOptionalCreateFundingAccountRequestok {
			return nil, reportError("createFundingAccountRequest should be CreateFundingAccountRequest")
		}
		localVarPostBody = &localVarOptionalCreateFundingAccountRequest
	}
