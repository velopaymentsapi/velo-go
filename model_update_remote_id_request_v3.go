...
// checks if the UpdateRemoteIdRequestV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateRemoteIdRequestV3{}

// UpdateRemoteIdRequestV3 struct for UpdateRemoteIdRequestV3
...
func (o UpdateRemoteIdRequestV3) MarshalJSON() ([]byte, error) {
...
func (o UpdateRemoteIdRequestV3) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateRemoteIdRequestV3 struct {
	value *UpdateRemoteIdRequestV3
	isSet bool
}

func (v NullableUpdateRemoteIdRequestV3) Get() *UpdateRemoteIdRequestV3 {
	return v.value
}

func (v *NullableUpdateRemoteIdRequestV3) Set(val *UpdateRemoteIdRequestV3) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateRemoteIdRequestV3) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateRemoteIdRequestV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateRemoteIdRequestV3(val *UpdateRemoteIdRequestV3) *NullableUpdateRemoteIdRequestV3 {
	return &NullableUpdateRemoteIdRequestV3{value: val, isSet: true}
}

func (v NullableUpdateRemoteIdRequestV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateRemoteIdRequestV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
