...
// checks if the QueryBatchResponseV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryBatchResponseV4{}

// QueryBatchResponseV4 struct for QueryBatchResponseV4
...
// SetFailures gets a reference to the given []FailedSubmissionV4 and assigns it to the Failures field.
func (o *QueryBatchResponseV4) SetFailures(v []FailedSubmissionV4) {
	o.Failures = v
}

func (o QueryBatchResponseV4) MarshalJSON() ([]byte, error) {
...
func (o QueryBatchResponseV4) ToMap() (map[string]interface{}, error) {
...
type NullableQueryBatchResponseV4 struct {
	value *QueryBatchResponseV4
	isSet bool
}

func (v NullableQueryBatchResponseV4) Get() *QueryBatchResponseV4 {
	return v.value
}

func (v *NullableQueryBatchResponseV4) Set(val *QueryBatchResponseV4) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryBatchResponseV4) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryBatchResponseV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryBatchResponseV4(val *QueryBatchResponseV4) *NullableQueryBatchResponseV4 {
	return &NullableQueryBatchResponseV4{value: val, isSet: true}
}

func (v NullableQueryBatchResponseV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryBatchResponseV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
