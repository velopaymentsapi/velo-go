...
// CreateIndividualName struct for CreateIndividualName
...
func (o CreateIndividualName) MarshalJSON() ([]byte, error) {
...
type NullableCreateIndividualName struct {
	value *CreateIndividualName
	isSet bool
}

func (v NullableCreateIndividualName) Get() *CreateIndividualName {
	return v.value
}

func (v *NullableCreateIndividualName) Set(val *CreateIndividualName) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateIndividualName) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateIndividualName) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateIndividualName(val *CreateIndividualName) *NullableCreateIndividualName {
	return &NullableCreateIndividualName{value: val, isSet: true}
}

func (v NullableCreateIndividualName) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateIndividualName) UnmarshalJSON(src []byte) error {
	v.isSet = true
