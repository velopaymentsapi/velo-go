...
// UpdateRemoteIdRequest2 struct for UpdateRemoteIdRequest2
...
func (o UpdateRemoteIdRequest2) MarshalJSON() ([]byte, error) {
...
type NullableUpdateRemoteIdRequest2 struct {
	value *UpdateRemoteIdRequest2
	isSet bool
}

func (v NullableUpdateRemoteIdRequest2) Get() *UpdateRemoteIdRequest2 {
	return v.value
}

func (v *NullableUpdateRemoteIdRequest2) Set(val *UpdateRemoteIdRequest2) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateRemoteIdRequest2) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateRemoteIdRequest2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateRemoteIdRequest2(val *UpdateRemoteIdRequest2) *NullableUpdateRemoteIdRequest2 {
	return &NullableUpdateRemoteIdRequest2{value: val, isSet: true}
}

func (v NullableUpdateRemoteIdRequest2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateRemoteIdRequest2) UnmarshalJSON(src []byte) error {
	v.isSet = true
