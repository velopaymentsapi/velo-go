...
// checks if the PayeeDeltaV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayeeDeltaV4{}

// PayeeDeltaV4 struct for PayeeDeltaV4
...
func (o *PayeeDeltaV4) SetEmailNil() {
	o.Email.Set(nil)
}
...
// GetPayeeCountry returns the PayeeCountry field value if set, zero value otherwise.
func (o *PayeeDeltaV4) GetPayeeCountry() string {
	if o == nil || IsNil(o.PayeeCountry) {
		var ret string
		return ret
	}
	return *o.PayeeCountry
}

// GetPayeeCountryOk returns a tuple with the PayeeCountry field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PayeeDeltaV4) GetPayeeCountryOk() (*string, bool) {
	if o == nil || IsNil(o.PayeeCountry) {
		return nil, false
	}
	return o.PayeeCountry, true
}
...
// SetPayeeCountry gets a reference to the given string and assigns it to the PayeeCountry field.
...
func (o PayeeDeltaV4) MarshalJSON() ([]byte, error) {
...
func (o PayeeDeltaV4) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PayeeCountry) {
		toSerialize["payeeCountry"] = o.PayeeCountry
	}
...
type NullablePayeeDeltaV4 struct {
	value *PayeeDeltaV4
	isSet bool
}

func (v NullablePayeeDeltaV4) Get() *PayeeDeltaV4 {
	return v.value
}

func (v *NullablePayeeDeltaV4) Set(val *PayeeDeltaV4) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeDeltaV4) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeDeltaV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeDeltaV4(val *PayeeDeltaV4) *NullablePayeeDeltaV4 {
	return &NullablePayeeDeltaV4{value: val, isSet: true}
}

func (v NullablePayeeDeltaV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeDeltaV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
