...
// SetContent gets a reference to the given []PayoutSummaryAuditV4 and assigns it to the Content field.
func (o *GetPayoutsResponseV4) SetContent(v []PayoutSummaryAuditV4) {
	o.Content = &v
}

func (o GetPayoutsResponseV4) MarshalJSON() ([]byte, error) {
...
type NullableGetPayoutsResponseV4 struct {
	value *GetPayoutsResponseV4
	isSet bool
}

func (v NullableGetPayoutsResponseV4) Get() *GetPayoutsResponseV4 {
	return v.value
}

func (v *NullableGetPayoutsResponseV4) Set(val *GetPayoutsResponseV4) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPayoutsResponseV4) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPayoutsResponseV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPayoutsResponseV4(val *GetPayoutsResponseV4) *NullableGetPayoutsResponseV4 {
	return &NullableGetPayoutsResponseV4{value: val, isSet: true}
}

func (v NullableGetPayoutsResponseV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPayoutsResponseV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
