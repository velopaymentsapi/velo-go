...
func NewPayeeInvitationStatusResponse(payeeId string, invitationStatus string) *PayeeInvitationStatusResponse {
	this := PayeeInvitationStatusResponse{}
...
func (o PayeeInvitationStatusResponse) MarshalJSON() ([]byte, error) {
...
type NullablePayeeInvitationStatusResponse struct {
	value *PayeeInvitationStatusResponse
	isSet bool
}

func (v NullablePayeeInvitationStatusResponse) Get() *PayeeInvitationStatusResponse {
	return v.value
}

func (v *NullablePayeeInvitationStatusResponse) Set(val *PayeeInvitationStatusResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeInvitationStatusResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeInvitationStatusResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeInvitationStatusResponse(val *PayeeInvitationStatusResponse) *NullablePayeeInvitationStatusResponse {
	return &NullablePayeeInvitationStatusResponse{value: val, isSet: true}
}

func (v NullablePayeeInvitationStatusResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeInvitationStatusResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
