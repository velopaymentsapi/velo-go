...
func (o Individual2) MarshalJSON() ([]byte, error) {
...
type NullableIndividual2 struct {
	value *Individual2
	isSet bool
}

func (v NullableIndividual2) Get() *Individual2 {
	return v.value
}

func (v *NullableIndividual2) Set(val *Individual2) {
	v.value = val
	v.isSet = true
}

func (v NullableIndividual2) IsSet() bool {
	return v.isSet
}

func (v *NullableIndividual2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIndividual2(val *Individual2) *NullableIndividual2 {
	return &NullableIndividual2{value: val, isSet: true}
}

func (v NullableIndividual2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIndividual2) UnmarshalJSON(src []byte) error {
	v.isSet = true
