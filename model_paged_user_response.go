...
func (o *PagedUserResponse) GetLinks() []PagedUserResponseLinks {
	if o == nil || IsNil(o.Links) {
		var ret []PagedUserResponseLinks
		return ret
	}
	return o.Links
}
...
// SetLinks gets a reference to the given []PagedUserResponseLinks and assigns it to the Links field.
...
// SetContent gets a reference to the given []UserResponse and assigns it to the Content field.
