...
// checks if the PaymentStatusChanged type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentStatusChanged{}

// PaymentStatusChanged Base type for all payment status changed events
...
func (o PaymentStatusChanged) MarshalJSON() ([]byte, error) {
...
func (o PaymentStatusChanged) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentStatusChanged struct {
	value *PaymentStatusChanged
	isSet bool
}

func (v NullablePaymentStatusChanged) Get() *PaymentStatusChanged {
	return v.value
}

func (v *NullablePaymentStatusChanged) Set(val *PaymentStatusChanged) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentStatusChanged) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentStatusChanged) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentStatusChanged(val *PaymentStatusChanged) *NullablePaymentStatusChanged {
	return &NullablePaymentStatusChanged{value: val, isSet: true}
}

func (v NullablePaymentStatusChanged) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentStatusChanged) UnmarshalJSON(src []byte) error {
	v.isSet = true
