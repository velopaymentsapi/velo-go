...
// checks if the SourceAccountV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceAccountV3{}
...
func (o SourceAccountV3) ToMap() (map[string]interface{}, error) {
