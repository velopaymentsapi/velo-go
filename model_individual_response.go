...
func (o IndividualResponse) MarshalJSON() ([]byte, error) {
...
type NullableIndividualResponse struct {
	value *IndividualResponse
	isSet bool
}

func (v NullableIndividualResponse) Get() *IndividualResponse {
	return v.value
}

func (v *NullableIndividualResponse) Set(val *IndividualResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableIndividualResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableIndividualResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIndividualResponse(val *IndividualResponse) *NullableIndividualResponse {
	return &NullableIndividualResponse{value: val, isSet: true}
}

func (v NullableIndividualResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIndividualResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
