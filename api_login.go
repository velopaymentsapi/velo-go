...
*/
func (a *LoginAPIService) ResetPassword(ctx context.Context) ApiResetPasswordRequest {
	return ApiResetPasswordRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *LoginAPIService) ResetPasswordExecute(r ApiResetPasswordRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *LoginAPIService) ValidateAccessToken(ctx context.Context) ApiValidateAccessTokenRequest {
	return ApiValidateAccessTokenRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *LoginAPIService) ValidateAccessTokenExecute(r ApiValidateAccessTokenRequest) (*AccessTokenResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiVeloAuthRequest) Execute() (*AuthResponse, *http.Response, error) {
...
*/
func (a *LoginAPIService) VeloAuth(ctx context.Context) ApiVeloAuthRequest {
	return ApiVeloAuthRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return AuthResponse
func (a *LoginAPIService) VeloAuthExecute(r ApiVeloAuthRequest) (*AuthResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	if r.grantType != nil {
		...
		var defaultValue string = "client_credentials"
		r.grantType = &defaultValue
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
