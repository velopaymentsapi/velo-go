...
func NewListSourceAccountResponse() *ListSourceAccountResponse {
	this := ListSourceAccountResponse{}
	return &this
}
...
// SetContent gets a reference to the given []SourceAccountResponse and assigns it to the Content field.
func (o *ListSourceAccountResponse) SetContent(v []SourceAccountResponse) {
	o.Content = &v
}

func (o ListSourceAccountResponse) MarshalJSON() ([]byte, error) {
...
type NullableListSourceAccountResponse struct {
	value *ListSourceAccountResponse
	isSet bool
}

func (v NullableListSourceAccountResponse) Get() *ListSourceAccountResponse {
	return v.value
}

func (v *NullableListSourceAccountResponse) Set(val *ListSourceAccountResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListSourceAccountResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListSourceAccountResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSourceAccountResponse(val *ListSourceAccountResponse) *NullableListSourceAccountResponse {
	return &NullableListSourceAccountResponse{value: val, isSet: true}
}

func (v NullableListSourceAccountResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSourceAccountResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
