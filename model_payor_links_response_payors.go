...
// checks if the PayorLinksResponsePayors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayorLinksResponsePayors{}
...
func (o PayorLinksResponsePayors) MarshalJSON() ([]byte, error) {
...
func (o PayorLinksResponsePayors) ToMap() (map[string]interface{}, error) {
...
type NullablePayorLinksResponsePayors struct {
	value *PayorLinksResponsePayors
	isSet bool
}

func (v NullablePayorLinksResponsePayors) Get() *PayorLinksResponsePayors {
	return v.value
}

func (v *NullablePayorLinksResponsePayors) Set(val *PayorLinksResponsePayors) {
	v.value = val
	v.isSet = true
}

func (v NullablePayorLinksResponsePayors) IsSet() bool {
	return v.isSet
}

func (v *NullablePayorLinksResponsePayors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayorLinksResponsePayors(val *PayorLinksResponsePayors) *NullablePayorLinksResponsePayors {
	return &NullablePayorLinksResponsePayors{value: val, isSet: true}
}

func (v NullablePayorLinksResponsePayors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayorLinksResponsePayors) UnmarshalJSON(src []byte) error {
	v.isSet = true
