...
func NewListFundingAccountsResponse() *ListFundingAccountsResponse {
	this := ListFundingAccountsResponse{}
	return &this
}
...
func (o *ListFundingAccountsResponse) GetContent() []FundingAccountResponse {
	if o == nil || o.Content == nil {
		var ret []FundingAccountResponse
		return ret
	}
	return *o.Content
}
...
// SetContent gets a reference to the given []FundingAccountResponse and assigns it to the Content field.
func (o *ListFundingAccountsResponse) SetContent(v []FundingAccountResponse) {
	o.Content = &v
}

func (o ListFundingAccountsResponse) MarshalJSON() ([]byte, error) {
...
type NullableListFundingAccountsResponse struct {
	value *ListFundingAccountsResponse
	isSet bool
}

func (v NullableListFundingAccountsResponse) Get() *ListFundingAccountsResponse {
	return v.value
}

func (v *NullableListFundingAccountsResponse) Set(val *ListFundingAccountsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListFundingAccountsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListFundingAccountsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListFundingAccountsResponse(val *ListFundingAccountsResponse) *NullableListFundingAccountsResponse {
	return &NullableListFundingAccountsResponse{value: val, isSet: true}
}

func (v NullableListFundingAccountsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListFundingAccountsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
