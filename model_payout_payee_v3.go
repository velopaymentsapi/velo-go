...
// checks if the PayoutPayeeV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayoutPayeeV3{}
...
func (o PayoutPayeeV3) ToMap() (map[string]interface{}, error) {
