...
func (o InvitePayeeRequest2) MarshalJSON() ([]byte, error) {
...
type NullableInvitePayeeRequest2 struct {
	value *InvitePayeeRequest2
	isSet bool
}

func (v NullableInvitePayeeRequest2) Get() *InvitePayeeRequest2 {
	return v.value
}

func (v *NullableInvitePayeeRequest2) Set(val *InvitePayeeRequest2) {
	v.value = val
	v.isSet = true
}

func (v NullableInvitePayeeRequest2) IsSet() bool {
	return v.isSet
}

func (v *NullableInvitePayeeRequest2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvitePayeeRequest2(val *InvitePayeeRequest2) *NullableInvitePayeeRequest2 {
	return &NullableInvitePayeeRequest2{value: val, isSet: true}
}

func (v NullableInvitePayeeRequest2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvitePayeeRequest2) UnmarshalJSON(src []byte) error {
	v.isSet = true
