...
// checks if the CreateIndividualV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateIndividualV4{}

// CreateIndividualV4 struct for CreateIndividualV4
...
func (o CreateIndividualV4) MarshalJSON() ([]byte, error) {
...
func (o CreateIndividualV4) ToMap() (map[string]interface{}, error) {
...
type NullableCreateIndividualV4 struct {
	value *CreateIndividualV4
	isSet bool
}

func (v NullableCreateIndividualV4) Get() *CreateIndividualV4 {
	return v.value
}

func (v *NullableCreateIndividualV4) Set(val *CreateIndividualV4) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateIndividualV4) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateIndividualV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateIndividualV4(val *CreateIndividualV4) *NullableCreateIndividualV4 {
	return &NullableCreateIndividualV4{value: val, isSet: true}
}

func (v NullableCreateIndividualV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateIndividualV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
