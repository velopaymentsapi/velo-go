...
// SetCurrency gets a reference to the given PaymentAuditCurrencyV4 and assigns it to the Currency field.
func (o *SourceAccountSummaryV4) SetCurrency(v PaymentAuditCurrencyV4) {
	o.Currency = &v
}

func (o SourceAccountSummaryV4) MarshalJSON() ([]byte, error) {
...
type NullableSourceAccountSummaryV4 struct {
	value *SourceAccountSummaryV4
	isSet bool
}

func (v NullableSourceAccountSummaryV4) Get() *SourceAccountSummaryV4 {
	return v.value
}

func (v *NullableSourceAccountSummaryV4) Set(val *SourceAccountSummaryV4) {
	v.value = val
	v.isSet = true
}

func (v NullableSourceAccountSummaryV4) IsSet() bool {
	return v.isSet
}

func (v *NullableSourceAccountSummaryV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSourceAccountSummaryV4(val *SourceAccountSummaryV4) *NullableSourceAccountSummaryV4 {
	return &NullableSourceAccountSummaryV4{value: val, isSet: true}
}

func (v NullableSourceAccountSummaryV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSourceAccountSummaryV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
