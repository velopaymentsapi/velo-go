...
// checks if the FundingRequestV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FundingRequestV3{}

// FundingRequestV3 struct for FundingRequestV3
...
func (o FundingRequestV3) MarshalJSON() ([]byte, error) {
...
func (o FundingRequestV3) ToMap() (map[string]interface{}, error) {
...
type NullableFundingRequestV3 struct {
	value *FundingRequestV3
	isSet bool
}

func (v NullableFundingRequestV3) Get() *FundingRequestV3 {
	return v.value
}

func (v *NullableFundingRequestV3) Set(val *FundingRequestV3) {
	v.value = val
	v.isSet = true
}

func (v NullableFundingRequestV3) IsSet() bool {
	return v.isSet
}

func (v *NullableFundingRequestV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFundingRequestV3(val *FundingRequestV3) *NullableFundingRequestV3 {
	return &NullableFundingRequestV3{value: val, isSet: true}
}

func (v NullableFundingRequestV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFundingRequestV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
