...
func (o PayorLogoRequest) MarshalJSON() ([]byte, error) {
...
type NullablePayorLogoRequest struct {
	value *PayorLogoRequest
	isSet bool
}

func (v NullablePayorLogoRequest) Get() *PayorLogoRequest {
	return v.value
}

func (v *NullablePayorLogoRequest) Set(val *PayorLogoRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePayorLogoRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePayorLogoRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayorLogoRequest(val *PayorLogoRequest) *NullablePayorLogoRequest {
	return &NullablePayorLogoRequest{value: val, isSet: true}
}

func (v NullablePayorLogoRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayorLogoRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
