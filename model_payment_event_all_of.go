...
// checks if the PaymentEventAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentEventAllOf{}

// PaymentEventAllOf struct for PaymentEventAllOf
type PaymentEventAllOf struct {
...
func (o PaymentEventAllOf) MarshalJSON() ([]byte, error) {
...
func (o PaymentEventAllOf) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentEventAllOf struct {
	value *PaymentEventAllOf
	isSet bool
}

func (v NullablePaymentEventAllOf) Get() *PaymentEventAllOf {
	return v.value
}

func (v *NullablePaymentEventAllOf) Set(val *PaymentEventAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentEventAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentEventAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentEventAllOf(val *PaymentEventAllOf) *NullablePaymentEventAllOf {
	return &NullablePaymentEventAllOf{value: val, isSet: true}
}

func (v NullablePaymentEventAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentEventAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
