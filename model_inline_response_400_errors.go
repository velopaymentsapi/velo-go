...
func (o InlineResponse400Errors) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse400Errors struct {
	value *InlineResponse400Errors
	isSet bool
}

func (v NullableInlineResponse400Errors) Get() *InlineResponse400Errors {
	return v.value
}

func (v *NullableInlineResponse400Errors) Set(val *InlineResponse400Errors) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse400Errors) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse400Errors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse400Errors(val *InlineResponse400Errors) *NullableInlineResponse400Errors {
	return &NullableInlineResponse400Errors{value: val, isSet: true}
}

func (v NullableInlineResponse400Errors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse400Errors) UnmarshalJSON(src []byte) error {
	v.isSet = true
