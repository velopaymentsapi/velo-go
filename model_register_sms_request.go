...
// checks if the RegisterSmsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegisterSmsRequest{}
...
func (o RegisterSmsRequest) MarshalJSON() ([]byte, error) {
...
func (o RegisterSmsRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["smsNumber"] = o.SmsNumber
	return toSerialize, nil
}

type NullableRegisterSmsRequest struct {
	value *RegisterSmsRequest
	isSet bool
}

func (v NullableRegisterSmsRequest) Get() *RegisterSmsRequest {
	return v.value
}

func (v *NullableRegisterSmsRequest) Set(val *RegisterSmsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableRegisterSmsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableRegisterSmsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegisterSmsRequest(val *RegisterSmsRequest) *NullableRegisterSmsRequest {
	return &NullableRegisterSmsRequest{value: val, isSet: true}
}

func (v NullableRegisterSmsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegisterSmsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
