...
func (o FxSummaryV4) MarshalJSON() ([]byte, error) {
...
type NullableFxSummaryV4 struct {
	value *FxSummaryV4
	isSet bool
}

func (v NullableFxSummaryV4) Get() *FxSummaryV4 {
	return v.value
}

func (v *NullableFxSummaryV4) Set(val *FxSummaryV4) {
	v.value = val
	v.isSet = true
}

func (v NullableFxSummaryV4) IsSet() bool {
	return v.isSet
}

func (v *NullableFxSummaryV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFxSummaryV4(val *FxSummaryV4) *NullableFxSummaryV4 {
	return &NullableFxSummaryV4{value: val, isSet: true}
}

func (v NullableFxSummaryV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFxSummaryV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
