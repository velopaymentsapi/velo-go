...
// Category The category into which the notification fails. One of * \"payment\" - notifications related to payments (submitted, accepted, rejected, returned) * \"payee\" - notifications related to payees (payor accepted, payor declined, payee updated) * \"debit\" - notifications related to debit events * \"funding\" - notifications related to funding (funding detected) 
type Category string

// List of Category
const (
	CATEGORY_PAYMENT Category = "payment"
	CATEGORY_PAYEE Category = "payee"
	CATEGORY_DEBIT Category = "debit"
	CATEGORY_FUNDING Category = "funding"
)
