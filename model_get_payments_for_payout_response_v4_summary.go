...
// SetPayoutType gets a reference to the given PayoutTypeV4 and assigns it to the PayoutType field.
...
// SetSubmitting gets a reference to the given PayoutPayorV4 and assigns it to the Submitting field.
...
// SetQuoted gets a reference to the given PayoutPrincipalV4 and assigns it to the Quoted field.
...
// SetInstructed gets a reference to the given PayoutPrincipalV4 and assigns it to the Instructed field.
...
// SetWithdrawn gets a reference to the given PayoutPrincipalV4 and assigns it to the Withdrawn field.
