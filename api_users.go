 ...
 */
func (a *UsersApiService) ResendToken(ctx _context.Context, userId string) ApiResendTokenRequest {
	return ApiResendTokenRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
 ...
 * Execute executes the request
 */
func (a *UsersApiService) ResendTokenExecute(r ApiResendTokenRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
