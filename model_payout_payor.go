...
// checks if the PayoutPayor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayoutPayor{}
...
// GetDbaName returns the DbaName field value
...
// GetDbaNameOk returns a tuple with the DbaName field value
// and a boolean to check if the value has been set.
...
func (o PayoutPayor) MarshalJSON() ([]byte, error) {
...
func (o PayoutPayor) ToMap() (map[string]interface{}, error) {
...
type NullablePayoutPayor struct {
	value *PayoutPayor
	isSet bool
}

func (v NullablePayoutPayor) Get() *PayoutPayor {
	return v.value
}

func (v *NullablePayoutPayor) Set(val *PayoutPayor) {
	v.value = val
	v.isSet = true
}

func (v NullablePayoutPayor) IsSet() bool {
	return v.isSet
}

func (v *NullablePayoutPayor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayoutPayor(val *PayoutPayor) *NullablePayoutPayor {
	return &NullablePayoutPayor{value: val, isSet: true}
}

func (v NullablePayoutPayor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayoutPayor) UnmarshalJSON(src []byte) error {
	v.isSet = true
