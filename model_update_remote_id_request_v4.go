...
// checks if the UpdateRemoteIdRequestV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateRemoteIdRequestV4{}

// UpdateRemoteIdRequestV4 struct for UpdateRemoteIdRequestV4
...
func (o UpdateRemoteIdRequestV4) MarshalJSON() ([]byte, error) {
...
func (o UpdateRemoteIdRequestV4) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateRemoteIdRequestV4 struct {
	value *UpdateRemoteIdRequestV4
	isSet bool
}

func (v NullableUpdateRemoteIdRequestV4) Get() *UpdateRemoteIdRequestV4 {
	return v.value
}

func (v *NullableUpdateRemoteIdRequestV4) Set(val *UpdateRemoteIdRequestV4) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateRemoteIdRequestV4) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateRemoteIdRequestV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateRemoteIdRequestV4(val *UpdateRemoteIdRequestV4) *NullableUpdateRemoteIdRequestV4 {
	return &NullableUpdateRemoteIdRequestV4{value: val, isSet: true}
}

func (v NullableUpdateRemoteIdRequestV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateRemoteIdRequestV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
