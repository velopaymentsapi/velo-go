...
func (o InvitePayeeRequest) MarshalJSON() ([]byte, error) {
...
type NullableInvitePayeeRequest struct {
	value *InvitePayeeRequest
	isSet bool
}

func (v NullableInvitePayeeRequest) Get() *InvitePayeeRequest {
	return v.value
}

func (v *NullableInvitePayeeRequest) Set(val *InvitePayeeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableInvitePayeeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableInvitePayeeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvitePayeeRequest(val *InvitePayeeRequest) *NullableInvitePayeeRequest {
	return &NullableInvitePayeeRequest{value: val, isSet: true}
}

func (v NullableInvitePayeeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvitePayeeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
