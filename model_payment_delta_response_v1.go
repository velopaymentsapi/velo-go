...
// checks if the PaymentDeltaResponseV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentDeltaResponseV1{}
...
// SetContent gets a reference to the given []PaymentDeltaV1 and assigns it to the Content field.
func (o *PaymentDeltaResponseV1) SetContent(v []PaymentDeltaV1) {
	o.Content = v
}

func (o PaymentDeltaResponseV1) MarshalJSON() ([]byte, error) {
...
func (o PaymentDeltaResponseV1) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentDeltaResponseV1 struct {
	value *PaymentDeltaResponseV1
	isSet bool
}

func (v NullablePaymentDeltaResponseV1) Get() *PaymentDeltaResponseV1 {
	return v.value
}

func (v *NullablePaymentDeltaResponseV1) Set(val *PaymentDeltaResponseV1) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentDeltaResponseV1) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentDeltaResponseV1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentDeltaResponseV1(val *PaymentDeltaResponseV1) *NullablePaymentDeltaResponseV1 {
	return &NullablePaymentDeltaResponseV1{value: val, isSet: true}
}

func (v NullablePaymentDeltaResponseV1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentDeltaResponseV1) UnmarshalJSON(src []byte) error {
	v.isSet = true
