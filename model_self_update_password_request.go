...
// checks if the SelfUpdatePasswordRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SelfUpdatePasswordRequest{}
...
func NewSelfUpdatePasswordRequest(oldPassword string, newPassword string) *SelfUpdatePasswordRequest {
	this := SelfUpdatePasswordRequest{}
...
func (o SelfUpdatePasswordRequest) MarshalJSON() ([]byte, error) {
...
func (o SelfUpdatePasswordRequest) ToMap() (map[string]interface{}, error) {
...
type NullableSelfUpdatePasswordRequest struct {
	value *SelfUpdatePasswordRequest
	isSet bool
}

func (v NullableSelfUpdatePasswordRequest) Get() *SelfUpdatePasswordRequest {
	return v.value
}

func (v *NullableSelfUpdatePasswordRequest) Set(val *SelfUpdatePasswordRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSelfUpdatePasswordRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSelfUpdatePasswordRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSelfUpdatePasswordRequest(val *SelfUpdatePasswordRequest) *NullableSelfUpdatePasswordRequest {
	return &NullableSelfUpdatePasswordRequest{value: val, isSet: true}
}

func (v NullableSelfUpdatePasswordRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSelfUpdatePasswordRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
