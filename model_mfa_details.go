...
// checks if the MFADetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MFADetails{}

// MFADetails struct for MFADetails
type MFADetails struct {
	MfaType NullableMFAType `json:"mfa_type,omitempty"`
...
func (o *MFADetails) SetMfaTypeNil() {
	o.MfaType.Set(nil)
}
...
func (o MFADetails) MarshalJSON() ([]byte, error) {
...
func (o MFADetails) ToMap() (map[string]interface{}, error) {
...
type NullableMFADetails struct {
	value *MFADetails
	isSet bool
}

func (v NullableMFADetails) Get() *MFADetails {
	return v.value
}

func (v *NullableMFADetails) Set(val *MFADetails) {
	v.value = val
	v.isSet = true
}

func (v NullableMFADetails) IsSet() bool {
	return v.isSet
}

func (v *NullableMFADetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMFADetails(val *MFADetails) *NullableMFADetails {
	return &NullableMFADetails{value: val, isSet: true}
}

func (v NullableMFADetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMFADetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
