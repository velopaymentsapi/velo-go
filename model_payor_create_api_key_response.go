...
// checks if the PayorCreateApiKeyResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayorCreateApiKeyResponse{}
...
func NewPayorCreateApiKeyResponse() *PayorCreateApiKeyResponse {
	this := PayorCreateApiKeyResponse{}
	return &this
}
...
func (o PayorCreateApiKeyResponse) MarshalJSON() ([]byte, error) {
...
func (o PayorCreateApiKeyResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePayorCreateApiKeyResponse struct {
	value *PayorCreateApiKeyResponse
	isSet bool
}

func (v NullablePayorCreateApiKeyResponse) Get() *PayorCreateApiKeyResponse {
	return v.value
}

func (v *NullablePayorCreateApiKeyResponse) Set(val *PayorCreateApiKeyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePayorCreateApiKeyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePayorCreateApiKeyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayorCreateApiKeyResponse(val *PayorCreateApiKeyResponse) *NullablePayorCreateApiKeyResponse {
	return &NullablePayorCreateApiKeyResponse{value: val, isSet: true}
}

func (v NullablePayorCreateApiKeyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayorCreateApiKeyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
