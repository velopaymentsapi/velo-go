...
func (o PayeePaymentChannel2) MarshalJSON() ([]byte, error) {
...
type NullablePayeePaymentChannel2 struct {
	value *PayeePaymentChannel2
	isSet bool
}

func (v NullablePayeePaymentChannel2) Get() *PayeePaymentChannel2 {
	return v.value
}

func (v *NullablePayeePaymentChannel2) Set(val *PayeePaymentChannel2) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeePaymentChannel2) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeePaymentChannel2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeePaymentChannel2(val *PayeePaymentChannel2) *NullablePayeePaymentChannel2 {
	return &NullablePayeePaymentChannel2{value: val, isSet: true}
}

func (v NullablePayeePaymentChannel2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeePaymentChannel2) UnmarshalJSON(src []byte) error {
	v.isSet = true
