...
// checks if the PayeeDeltaV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayeeDeltaV3{}

// PayeeDeltaV3 struct for PayeeDeltaV3
...
func (o *PayeeDeltaV3) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o PayeeDeltaV3) MarshalJSON() ([]byte, error) {
...
func (o PayeeDeltaV3) ToMap() (map[string]interface{}, error) {
...
type NullablePayeeDeltaV3 struct {
	value *PayeeDeltaV3
	isSet bool
}

func (v NullablePayeeDeltaV3) Get() *PayeeDeltaV3 {
	return v.value
}

func (v *NullablePayeeDeltaV3) Set(val *PayeeDeltaV3) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeeDeltaV3) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeeDeltaV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeeDeltaV3(val *PayeeDeltaV3) *NullablePayeeDeltaV3 {
	return &NullablePayeeDeltaV3{value: val, isSet: true}
}

func (v NullablePayeeDeltaV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeeDeltaV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
