...
// checks if the PaymentChannelCountry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentChannelCountry{}
...
func (o PaymentChannelCountry) MarshalJSON() ([]byte, error) {
...
func (o PaymentChannelCountry) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentChannelCountry struct {
	value *PaymentChannelCountry
	isSet bool
}

func (v NullablePaymentChannelCountry) Get() *PaymentChannelCountry {
	return v.value
}

func (v *NullablePaymentChannelCountry) Set(val *PaymentChannelCountry) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentChannelCountry) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentChannelCountry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentChannelCountry(val *PaymentChannelCountry) *NullablePaymentChannelCountry {
	return &NullablePaymentChannelCountry{value: val, isSet: true}
}

func (v NullablePaymentChannelCountry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentChannelCountry) UnmarshalJSON(src []byte) error {
	v.isSet = true
