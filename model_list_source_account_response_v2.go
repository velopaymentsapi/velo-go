...
// checks if the ListSourceAccountResponseV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListSourceAccountResponseV2{}
...
func NewListSourceAccountResponseV2() *ListSourceAccountResponseV2 {
	this := ListSourceAccountResponseV2{}
	return &this
}
...
// SetPage gets a reference to the given PagedUserResponsePage and assigns it to the Page field.
...
func (o *ListSourceAccountResponseV2) GetContent() []SourceAccountResponseV2 {
	if o == nil || IsNil(o.Content) {
		var ret []SourceAccountResponseV2
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []SourceAccountResponseV2 and assigns it to the Content field.
func (o *ListSourceAccountResponseV2) SetContent(v []SourceAccountResponseV2) {
	o.Content = v
}

func (o ListSourceAccountResponseV2) MarshalJSON() ([]byte, error) {
...
func (o ListSourceAccountResponseV2) ToMap() (map[string]interface{}, error) {
...
type NullableListSourceAccountResponseV2 struct {
	value *ListSourceAccountResponseV2
	isSet bool
}

func (v NullableListSourceAccountResponseV2) Get() *ListSourceAccountResponseV2 {
	return v.value
}

func (v *NullableListSourceAccountResponseV2) Set(val *ListSourceAccountResponseV2) {
	v.value = val
	v.isSet = true
}

func (v NullableListSourceAccountResponseV2) IsSet() bool {
	return v.isSet
}

func (v *NullableListSourceAccountResponseV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSourceAccountResponseV2(val *ListSourceAccountResponseV2) *NullableListSourceAccountResponseV2 {
	return &NullableListSourceAccountResponseV2{value: val, isSet: true}
}

func (v NullableListSourceAccountResponseV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSourceAccountResponseV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
