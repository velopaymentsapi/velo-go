...
// checks if the PayeePayorRefV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayeePayorRefV4{}

// PayeePayorRefV4 struct for PayeePayorRefV4
...
func (o *PayeePayorRefV4) SetInvitationStatusTimestampNil() {
...
// SetPayableIssues gets a reference to the given []PayableIssueV4 and assigns it to the PayableIssues field.
func (o *PayeePayorRefV4) SetPayableIssues(v []PayableIssueV4) {
	o.PayableIssues = v
}

func (o PayeePayorRefV4) MarshalJSON() ([]byte, error) {
...
func (o PayeePayorRefV4) ToMap() (map[string]interface{}, error) {
...
type NullablePayeePayorRefV4 struct {
	value *PayeePayorRefV4
	isSet bool
}

func (v NullablePayeePayorRefV4) Get() *PayeePayorRefV4 {
	return v.value
}

func (v *NullablePayeePayorRefV4) Set(val *PayeePayorRefV4) {
	v.value = val
	v.isSet = true
}

func (v NullablePayeePayorRefV4) IsSet() bool {
	return v.isSet
}

func (v *NullablePayeePayorRefV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayeePayorRefV4(val *PayeePayorRefV4) *NullablePayeePayorRefV4 {
	return &NullablePayeePayorRefV4{value: val, isSet: true}
}

func (v NullablePayeePayorRefV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayeePayorRefV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
