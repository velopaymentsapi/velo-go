...
// Notifications2 struct for Notifications2
...
func (o Notifications2) MarshalJSON() ([]byte, error) {
...
type NullableNotifications2 struct {
	value *Notifications2
	isSet bool
}

func (v NullableNotifications2) Get() *Notifications2 {
	return v.value
}

func (v *NullableNotifications2) Set(val *Notifications2) {
	v.value = val
	v.isSet = true
}

func (v NullableNotifications2) IsSet() bool {
	return v.isSet
}

func (v *NullableNotifications2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotifications2(val *Notifications2) *NullableNotifications2 {
	return &NullableNotifications2{value: val, isSet: true}
}

func (v NullableNotifications2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotifications2) UnmarshalJSON(src []byte) error {
	v.isSet = true
