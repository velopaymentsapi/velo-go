...
// checks if the PayorToPaymentChannelMappingV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayorToPaymentChannelMappingV4{}

// PayorToPaymentChannelMappingV4 struct for PayorToPaymentChannelMappingV4
type PayorToPaymentChannelMappingV4 struct {
...
func NewPayorToPaymentChannelMappingV4() *PayorToPaymentChannelMappingV4 {
	this := PayorToPaymentChannelMappingV4{}
	return &this
}
...
func (o PayorToPaymentChannelMappingV4) MarshalJSON() ([]byte, error) {
...
func (o PayorToPaymentChannelMappingV4) ToMap() (map[string]interface{}, error) {
...
type NullablePayorToPaymentChannelMappingV4 struct {
	value *PayorToPaymentChannelMappingV4
	isSet bool
}

func (v NullablePayorToPaymentChannelMappingV4) Get() *PayorToPaymentChannelMappingV4 {
	return v.value
}

func (v *NullablePayorToPaymentChannelMappingV4) Set(val *PayorToPaymentChannelMappingV4) {
	v.value = val
	v.isSet = true
}

func (v NullablePayorToPaymentChannelMappingV4) IsSet() bool {
	return v.isSet
}

func (v *NullablePayorToPaymentChannelMappingV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayorToPaymentChannelMappingV4(val *PayorToPaymentChannelMappingV4) *NullablePayorToPaymentChannelMappingV4 {
	return &NullablePayorToPaymentChannelMappingV4{value: val, isSet: true}
}

func (v NullablePayorToPaymentChannelMappingV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayorToPaymentChannelMappingV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
